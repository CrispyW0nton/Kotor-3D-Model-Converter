...
4. Extend `GhostRigger.Runtime.Shared.Resources` when future renderer-neutral
   ...
   schema metadata.
5. Extend `GhostRigger.Renderer.D3D12` from retained device/queue lifetime
   diagnostics into descriptor-heap and command-allocator readiness diagnostics
   before adding real draw submission.
