...
PROJECT_DIR = ROOT / "native" / "GhostRigger.Core.Project"
DLL_PATH = ROOT / "build" / "vs" / "x64" / "Release" / "GhostRigger.Core.Project.dll"
...
def test_project_declares_native_resource_address_files() -> None:
    project = (PROJECT_DIR / "GhostRigger.Core.Project.vcxproj").read_text(encoding="utf-8")
    filters = (PROJECT_DIR / "GhostRigger.Core.Project.vcxproj.filters").read_text(encoding="utf-8")
    ...
    assert "namespace ghostrigger::core::project::core::project::resource_address" in header
    assert "namespace ghostrigger::core::project::core::project::resource_address" in implementation
