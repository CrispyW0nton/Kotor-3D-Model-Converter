...
HEADER = ROOT / "native" / "GhostRigger.Core.Math" / "Public" / "MeasurementContracts.h"
SOURCE = ROOT / "native" / "GhostRigger.Core.Math" / "Private" / "MeasurementContracts.cpp"
...
def test_measurement_contracts_are_explicit_in_visual_studio_project() -> None:
    ...
    assert "namespace ghostrigger::core::measurement::core::measurement::contracts" in source_text
    assert "namespace ghostrigger::core::measurement::core::measurement::contracts" in header_text
