...
PROJECT_DIR = ROOT / "native" / "GhostRigger.Core.Rendering"
...
def test_rendering_project_declares_contract_files_and_exports() -> None:
    project = (PROJECT_DIR / "GhostRigger.Core.Rendering.vcxproj").read_text(encoding="utf-8")
    filters = (PROJECT_DIR / "GhostRigger.Core.Rendering.vcxproj.filters").read_text(encoding="utf-8")
    ...
    assert "namespace ghostrigger::core::rendering::core::rendering::rendering_contracts" in public_header
    assert "namespace ghostrigger::core::rendering::core::rendering::rendering_contracts" in implementation
