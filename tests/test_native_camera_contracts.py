...
DLL = ROOT / "build" / "vs" / "x64" / "Release" / "GhostRigger.Camera.dll"
PROJECT = ROOT / "native" / "GhostRigger.Camera" / "GhostRigger.Camera.vcxproj"
FILTERS = ROOT / "native" / "GhostRigger.Camera" / "GhostRigger.Camera.vcxproj.filters"
HEADER = ROOT / "native" / "GhostRigger.Camera" / "Public" / "CameraContracts.h"
SOURCE = ROOT / "native" / "GhostRigger.Camera" / "Private" / "CameraContracts.cpp"
...
def test_camera_contracts_are_explicit_in_visual_studio_project() -> None:
    ...
    assert "namespace ghostrigger::camera::core::camera::contracts" in source_text
    assert "namespace ghostrigger::camera::core::camera::contracts" in header_text
