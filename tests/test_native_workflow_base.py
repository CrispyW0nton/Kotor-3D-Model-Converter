...
def test_workflow_project_declares_workflow_base_files_and_exports() -> None:
    ...
    assert "namespace ghostrigger::core::workflow::core::workflow::workflow_base" in public_header
    assert "namespace ghostrigger::core::workflow::core::workflow::workflow_base" in implementation
