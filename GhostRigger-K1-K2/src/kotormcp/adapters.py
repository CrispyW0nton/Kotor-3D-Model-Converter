...
class MDLBinaryParserAdapter(ModelParserPort):
    """
    Adapter: parse raw MDL+MDX bytes using the project's MDLBinaryParser.

    All knowledge of MDLBinaryParser's API is contained here.
    """
    ...
    def parse(self, mdl: bytes, mdx: bytes, path_label: str) -> Any:
        ...
        from core.mdl_parser import MDLBinaryParser  # noqa: PLC0415
