...
def rebuild_templates(out_dir: Optional[str] = None) -> List[str]:
    ...
    try:
        try:
            ...
            from core.mdl_parser import MDLBinaryParser, MDLAsciiWriter, MDLAsciiParser  # type: ignore
            from core.model_data import NodeFlags  # type: ignore
        except ImportError:
            from src.core.kotor_install import KotorInstallation  # type: ignore
            from src.core.mdl_parser import MDLBinaryParser, MDLAsciiWriter, MDLAsciiParser  # type: ignore
