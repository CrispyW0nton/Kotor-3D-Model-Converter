...
const NativeFunctionImplementation& creatureassembly_from_models_line_1193_dfce9043_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Core.Workflow.Characters","namespace":"ghostrigger::core::characters::core::characters::creature_appearance","python_file":"src/core/characters/creature_appearance.py","qualname":"CreatureAssembly.from_models","name":"from_models","callable_type":"class_methods","line":1193,"end_line":1257,"signature":{"args":["cls","body_model","head_model","game"],"positional_count":4,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
...
const NativeFunctionImplementation& creatureassembly_from_resrefs_line_1260_9de5d9fa_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Core.Workflow.Characters","namespace":"ghostrigger::core::characters::core::characters::creature_appearance","python_file":"src/core/characters/creature_appearance.py","qualname":"CreatureAssembly.from_resrefs","name":"from_resrefs","callable_type":"class_methods","line":1260,"end_line":1312,"signature":{"args":["cls","body_resref","head_resref","resource_manager","game"],"positional_count":5,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
...
const NativeFunctionImplementation& nativenodesnapshot_from_dict_line_77_23599e67_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Core.Workflow.Characters","namespace":"ghostrigger::core::characters::core::characters::native_skeleton","python_file":"src/core/characters/native_skeleton.py","qualname":"NativeNodeSnapshot.from_dict","name":"from_dict","callable_type":"class_methods","line":77,"end_line":82,"signature":{"args":["cls","data"],"positional_count":2,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
...
const NativeFunctionImplementation& nativeskeletonsnapshot_from_dict_line_107_3c42a345_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Core.Workflow.Characters","namespace":"ghostrigger::core::characters::core::characters::native_skeleton","python_file":"src/core/characters/native_skeleton.py","qualname":"NativeSkeletonSnapshot.from_dict","name":"from_dict","callable_type":"class_methods","line":107,"end_line":114,"signature":{"args":["cls","data"],"positional_count":2,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
