...
#include "GhostRiggerCharacters.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"characters_owner_boundary.v1",)"
    R"("module_package":"GhostRigger.Core.Workflow.Characters",)"
    R"("source_package":"src/core/characters",)"
    R"("owner_surface":"Character Studio core",)"
    R"("owner_package":"native/GhostRigger.Core.Workflow.Characters",)"
...
constexpr const char* kDependencySchema =
    R"({"schema":"characters_dependency_schema.v1",)"
    R"("module_package":"GhostRigger.Core.Workflow.Characters",)"
    R"("source_package":"src/core/characters",)"
    R"("diagnostic_only":true,)"
...
GHOSTRIGGER_CHARACTERS_API const char* gr_characters_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Workflow.Characters","version":"0.1.0",)"
           R"("phase":"P1 module sweep","module_package":true,)"
           R"("source_package":"src/core/characters",)"
           R"("owner_surface":"Character Studio core","bridge_method":"C ABI DLL",)"
