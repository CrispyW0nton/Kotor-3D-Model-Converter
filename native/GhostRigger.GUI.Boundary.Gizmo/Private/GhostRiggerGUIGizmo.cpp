...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.GUI.Boundary.Gizmo",)"
    R"("source_package":"src/gui/gizmo",)"
    R"("owner_surface":"GUI gizmo helpers",)"
    R"("owner_package":"native/GhostRigger.GUI.Boundary.Gizmo",)"
...
GHOSTRIGGER_GUI_GIZMO_API const char* gr_gui_gizmo_capabilities_json() {
    return R"({"name":"GhostRigger.GUI.Boundary.Gizmo","version":"0.1.0",)"
