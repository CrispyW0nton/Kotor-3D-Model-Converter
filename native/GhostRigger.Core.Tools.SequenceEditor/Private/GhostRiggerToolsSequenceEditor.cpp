...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Core.Tools.SequenceEditor",)"
    R"("owner_surface":"Sequence Editor",)"
    R"("owner_package":"native/GhostRigger.Core.Tools.SequenceEditor",)"
...
GR_TOOLS_SEQUENCE_EDITOR_API const char* gr_tools_sequence_editor_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Tools.SequenceEditor","version":"0.1.0",)"
