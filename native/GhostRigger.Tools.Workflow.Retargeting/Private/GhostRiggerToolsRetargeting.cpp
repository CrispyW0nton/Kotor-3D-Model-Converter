...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.Workflow.Retargeting",)"
    R"("owner_surface":"Retarget Workbench",)"
    R"("owner_package":"native/GhostRigger.Tools.Workflow.Retargeting",)"
...
GR_TOOLS_RETARGETING_API const char* gr_tools_retargeting_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.Workflow.Retargeting","version":"0.1.0",)"
