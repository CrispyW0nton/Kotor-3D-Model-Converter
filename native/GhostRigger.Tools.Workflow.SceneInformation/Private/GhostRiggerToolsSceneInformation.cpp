...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.Workflow.SceneInformation",)"
    R"("owner_surface":"Scene Information",)"
    R"("owner_package":"native/GhostRigger.Tools.Workflow.SceneInformation",)"
...
GR_TOOLS_SCENE_INFORMATION_API const char* gr_tools_scene_information_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.Workflow.SceneInformation","version":"0.1.0",)"
