...
namespace gizmo_mode = ghostrigger::core::gizmo::core::gizmo::gizmo_mode;
...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.GUI.Helpers.Gizmo",)"
    R"("source_package":"src/core/gizmo",)"
    R"("owner_surface":"Transform gizmo services",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Helpers.Gizmo",)"
...
GHOSTRIGGER_GIZMO_API const char* gr_gizmo_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Helpers.Gizmo","version":"0.1.0",)"
