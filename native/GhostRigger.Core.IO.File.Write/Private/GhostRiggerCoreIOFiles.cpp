...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.IO.File.Write",)"
    R"("source_package":"src/adapters/files",)"
    R"("owner_surface":"File adapters",)"
    R"("owner_package":"native/GhostRigger.Core.IO.File.Write",)"
...
GHOSTRIGGER_CORE_IO_FILES_API const char* gr_core_io_files_capabilities_json() {
    return R"({"name":"GhostRigger.Core.IO.File.Write","version":"0.1.0",)"
