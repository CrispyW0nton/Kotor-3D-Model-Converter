...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Export",)"
    R"("source_package":"src/core/export",)"
    R"("owner_surface":"Export pipeline core",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Export",)"
...
GHOSTRIGGER_EXPORT_API const char* gr_export_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Export","version":"0.1.0",)"
