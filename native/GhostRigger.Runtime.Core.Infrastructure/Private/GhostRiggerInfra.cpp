...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Runtime.Core.Infrastructure",)"
    R"("source_package":"src/infra",)"
    R"("owner_surface":"Infrastructure services",)"
    R"("owner_package":"native/GhostRigger.Runtime.Core.Infrastructure",)"
...
GHOSTRIGGER_INFRA_API const char* gr_infra_capabilities_json() {
    return R"({"name":"GhostRigger.Runtime.Core.Infrastructure","version":"0.1.0",)"
