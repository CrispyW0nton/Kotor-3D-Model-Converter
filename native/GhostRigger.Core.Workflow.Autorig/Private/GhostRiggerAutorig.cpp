...
#include "GhostRiggerAutorig.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"autorig_owner_boundary.v1",)"
    R"("module_package":"GhostRigger.Core.Workflow.Autorig",)"
    R"("source_package":"src/autorig",)"
    R"("owner_surface":"Auto-rigging services",)"
    R"("owner_package":"native/GhostRigger.Core.Workflow.Autorig",)"
...
constexpr const char* kDependencySchema =
    R"({"schema":"autorig_dependency_schema.v1",)"
    R"("module_package":"GhostRigger.Core.Workflow.Autorig",)"
    R"("source_package":"src/autorig",)"
    R"("diagnostic_only":true,)"
...
GHOSTRIGGER_AUTORIG_API const char* gr_autorig_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Workflow.Autorig","version":"0.1.0",)"
           R"("phase":"P1 module sweep","module_package":true,)"
           R"("source_package":"src/autorig",)"
           R"("owner_surface":"Auto-rigging services","bridge_method":"C ABI DLL",)"
