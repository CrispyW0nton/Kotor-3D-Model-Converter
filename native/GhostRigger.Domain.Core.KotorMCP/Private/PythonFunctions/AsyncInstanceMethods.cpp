...
const NativeFunctionImplementation& fallbackhttpserver_serve_line_162_44154bbb_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Domain.Core.KotorMCP","namespace":"ghostrigger::domain::core::kotormcp::server","python_file":"src/kotormcp/server.py","qualname":"_FallbackHTTPServer.serve","name":"serve","callable_type":"async_instance_methods","line":162,"end_line":170,"signature":{"args":["self"],"positional_count":1,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
