...
const NativeFunctionImplementation& vec3_line_291_f6acbc46_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Adapters.GPU","namespace":"ghostrigger::adapters::gpu::lightmap_gpu_solver","python_file":"src/adapters/gpu/lightmap_gpu_solver.py","qualname":"_vec3","name":"_vec3","callable_type":"module_functions","line":291,"end_line":295,"signature":{"args":["value","fallback"],"positional_count":2,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
...
const NativeFunctionImplementation& gl_context_backend_candidates_line_19_4983a56d_native() {
    static const NativeFunctionImplementation implementation = {
        "GhostRigger.Adapters.GPU",
        "ghostrigger::adapters::gpu::moderngl_context",
...
const NativeFunctionImplementation& gr_gpu_probe_line_16_3850cbae_native() {
    static const NativeFunctionImplementation implementation = {
        "GhostRigger.Adapters.GPU",
        "ghostrigger::adapters::gpu::viewport_probe",
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Adapters.GPU","namespace":"ghostrigger::adapters::gpu::viewport_probe","python_file":"src/adapters/gpu/viewport_probe.py","qualname":"_gr_gpu_probe","name":"_gr_gpu_probe","callable_type":"module_functions","line":16,"end_line":61,"signature":{"args":["node","wp","wo","is_id_rot","composite_off"],"positional_count":5,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
