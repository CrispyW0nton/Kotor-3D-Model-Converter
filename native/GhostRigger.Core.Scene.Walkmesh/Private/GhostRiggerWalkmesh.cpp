...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Scene.Walkmesh",)"
    R"("source_package":"src/core/walkmesh",)"
    R"("owner_surface":"Walkmesh editing",)"
    R"("owner_package":"native/GhostRigger.Core.Scene.Walkmesh",)"
...
GHOSTRIGGER_WALKMESH_API const char* gr_walkmesh_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Scene.Walkmesh","version":"0.1.0",)"
