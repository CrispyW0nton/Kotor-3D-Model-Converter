...
GHOSTRIGGER_CORE_RENDERING_GPU_API const char* gr_core_rendering_gpu_gl_backend_candidates_json(
    ...
    json = json_string_array(ghostrigger::core::rendering::gpu::gl_context_backend_candidates(os_name));
    return json.c_str();
}
...
GHOSTRIGGER_CORE_RENDERING_GPU_API int gr_core_rendering_gpu_light_kind_code(
    ...
    return ghostrigger::core::rendering::gpu::light_kind_code(light_kind, ambient_only != 0);
}
