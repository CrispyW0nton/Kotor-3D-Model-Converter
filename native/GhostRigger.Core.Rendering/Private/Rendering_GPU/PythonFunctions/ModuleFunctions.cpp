#include "Rendering_GPU/PythonFunctions/ModuleFunctions.h"
#include "Rendering_GPU/GpuAdapterContracts.h"
...
const NativeFunctionImplementation& kind_code_line_278_064e698f_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        "ghostrigger::core::rendering::gpu::lightmap_gpu_solver",
...
const NativeFunctionImplementation& gl_context_backend_candidates_line_19_4983a56d_native() {
    static const NativeFunctionImplementation implementation = {
        "GhostRigger.Core.Rendering",
        "ghostrigger::core::rendering::gpu::moderngl_context",
...
const NativeFunctionImplementation& gr_gpu_probe_line_16_3850cbae_native() {
    static const NativeFunctionImplementation implementation = {
        "GhostRigger.Core.Rendering",
        "ghostrigger::core::rendering::gpu::viewport_probe",
