...
#include "Rendering_Backends_ModernGL/GhostRiggerRendererModernGL.h"
...
constexpr const char* kAdapterBridge =
    ...
    R"("renderer_package":"GhostRigger.Core.Rendering",)"
    R"("contract_package":"GhostRigger.Core.Rendering",)"
