...
_NATIVE_GPU_ADAPTER_DLL = "GhostRigger.Core.Rendering.dll"
...
def _native_gpu_adapter_candidates() -> Tuple[Path, ...]:
    ...
    return (
        ...
        root / "native" / "GhostRigger.Core.Rendering.dll" / "build" / "vs" / "x64" / "Debug" / _NATIVE_GPU_ADAPTER_DLL,
        root / "native" / "GhostRigger.Core.Rendering.dll" / "build" / "vs" / "x64" / "Release" / _NATIVE_GPU_ADAPTER_DLL,
    )
