...
{
    return R"json({"package":"GhostRigger.Runtime.Shared.Contracts","version":"0.1.0","native_core_version":"0.1.0","renderer_neutral_contracts":true,"shared_runtime_contracts":true,"python_detectable":true})json";
}
