...
namespace resource_manager = ghostrigger::domain::core::assets::core::assets::resource_manager;
...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Assets",)"
    R"("source_package":"src/core/assets",)"
    R"("owner_surface":"Asset services",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Assets",)"
...
GHOSTRIGGER_ASSETS_API const char* gr_assets_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Assets","version":"0.1.0",)"
