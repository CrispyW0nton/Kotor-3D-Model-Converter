...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.NodesSkeletonBrowser",)"
    R"("owner_surface":"Nodes/Skeleton Browser",)"
    R"("owner_package":"native/GhostRigger.Tools.NodesSkeletonBrowser",)"
...
GR_TOOLS_NODES_SKELETON_BROWSER_API const char* gr_tools_nodes_skeleton_browser_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.NodesSkeletonBrowser","version":"0.1.0",)"
