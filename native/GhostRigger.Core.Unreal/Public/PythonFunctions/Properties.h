...
#ifndef GHOSTRIGGER_CORE_UNREAL_NATIVE_FUNCTION_IMPLEMENTATION_DEFINED
#define GHOSTRIGGER_CORE_UNREAL_NATIVE_FUNCTION_IMPLEMENTATION_DEFINED
...
#endif // GHOSTRIGGER_CORE_UNREAL_NATIVE_FUNCTION_IMPLEMENTATION_DEFINED
