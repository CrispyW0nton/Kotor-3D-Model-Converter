...
#include "Unreal/GhostRiggerCoreUnreal.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"core_unreal_owner_boundary.v1",)"
    R"("module_package":"GhostRigger.Core.Unreal",)"
    R"("source_package":"src/unreal",)"
    R"("owner_surface":"Unreal integration",)"
    R"("owner_package":"native/GhostRigger.Core.Unreal",)"
...
GHOSTRIGGER_CORE_UNREAL_API const char* gr_unreal_version() {
    return kVersion;
}

GHOSTRIGGER_CORE_UNREAL_API const char* gr_unreal_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Unreal","version":"0.1.0",)"
...
GHOSTRIGGER_CORE_UNREAL_API const char* gr_core_unreal_owner_boundary_json() {
    return kOwnerBoundary;
}

GHOSTRIGGER_CORE_UNREAL_API const char* gr_unreal_dependency_schema_json() {
