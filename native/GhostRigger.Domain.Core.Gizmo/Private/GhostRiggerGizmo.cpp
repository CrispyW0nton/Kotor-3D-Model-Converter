...
namespace gizmo_mode = ghostrigger::domain::core::gizmo::core::gizmo::gizmo_mode;
...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Gizmo",)"
    R"("source_package":"src/core/gizmo",)"
    R"("owner_surface":"Transform gizmo services",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Gizmo",)"
...
GHOSTRIGGER_GIZMO_API const char* gr_gizmo_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Gizmo","version":"0.1.0",)"
