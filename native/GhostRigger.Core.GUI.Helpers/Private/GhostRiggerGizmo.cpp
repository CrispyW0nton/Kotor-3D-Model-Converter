...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.GUI.Helpers",)"
    R"("source_package":"src/core/gizmo",)"
    R"("owner_surface":"Transform gizmo services",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Helpers",)"
...
GHOSTRIGGER_GIZMO_API const char* gr_gizmo_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Helpers","version":"0.1.0",)"
