...
#include "GhostRiggerGUITextures.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"gui_textures_owner_boundary.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.Textures",)"
    R"("source_package":"src/gui/textures",)"
    R"("owner_surface":"GUI texture helpers",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Display.Textures",)"
...
constexpr const char* kDependencySchema =
    R"({"schema":"gui_textures_dependency_schema.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.Textures",)"
    R"("source_package":"src/gui/textures",)"
    R"("diagnostic_only":true,)"
...
GHOSTRIGGER_GUI_TEXTURES_API const char* gr_gui_textures_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Display.Textures","version":"0.1.0",)"
           R"("phase":"P1 module sweep","module_package":true,)"
           R"("source_package":"src/gui/textures",)"
           R"("owner_surface":"GUI texture helpers","bridge_method":"C ABI DLL",)"
