...
namespace ghostrigger::domain::core::camera::core::camera::contracts {
namespace {
...
__declspec(dllexport) double gr_camera_focal_length_to_fov(double sensor_width_mm, double focal_length_mm) {
    return ghostrigger::domain::core::camera::core::camera::contracts::focal_length_to_fov(sensor_width_mm, focal_length_mm);
}

__declspec(dllexport) double gr_camera_fov_to_focal_length(double sensor_width_mm, double fov_degrees) {
    return ghostrigger::domain::core::camera::core::camera::contracts::fov_to_focal_length(sensor_width_mm, fov_degrees);
}

__declspec(dllexport) void gr_camera_normalize_quat(double x, double y, double z, double w, double* out_xyzw) {
    ghostrigger::domain::core::camera::core::camera::contracts::normalize_quat(x, y, z, w, out_xyzw);
}

__declspec(dllexport) const char* gr_camera_normalize_type(const char* camera_type) {
    return ghostrigger::domain::core::camera::core::camera::contracts::normalize_camera_type(camera_type);
}

__declspec(dllexport) const char* gr_camera_normalize_render_format(const char* output_format) {
    return ghostrigger::domain::core::camera::core::camera::contracts::normalize_render_format(output_format);
}

__declspec(dllexport) const char* gr_camera_render_output_extension(const char* output_format) {
    return ghostrigger::domain::core::camera::core::camera::contracts::render_output_extension(output_format);
}

__declspec(dllexport) int gr_camera_validate_dimension(int value) {
    return ghostrigger::domain::core::camera::core::camera::contracts::validate_dimension(value);
}

__declspec(dllexport) int gr_camera_validate_jpg_quality(int value) {
    return ghostrigger::domain::core::camera::core::camera::contracts::validate_jpg_quality(value);
}

__declspec(dllexport) const char* gr_camera_sanitize_filename(const char* name) {
    return ghostrigger::domain::core::camera::core::camera::contracts::sanitize_filename(name);
}

__declspec(dllexport) const char* gr_camera_sensor_preset_json(const char* name) {
    return ghostrigger::domain::core::camera::core::camera::contracts::sensor_preset_json(name);
}

__declspec(dllexport) double gr_camera_lens_preset_mm(const char* name, double fallback) {
    return ghostrigger::domain::core::camera::core::camera::contracts::lens_preset_mm(name, fallback);
}

__declspec(dllexport) const char* gr_camera_contracts_schema_json() {
    return ghostrigger::domain::core::camera::core::camera::contracts::camera_contracts_schema_json();
}
