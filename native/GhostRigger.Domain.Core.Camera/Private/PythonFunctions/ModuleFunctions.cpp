...
const NativeFunctionImplementation& append_render_manifest_line_24_1e0aa46a_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        "ghostrigger::domain::core::camera::core::camera::render_manifest",
