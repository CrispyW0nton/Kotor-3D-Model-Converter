...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Project",)"
    R"("source_package":"src/core/project",)"
    R"("owner_surface":"Project and session infrastructure",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Project",)"
...
GHOSTRIGGER_PROJECT_API const char* gr_project_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Project","version":"0.1.0",)"
