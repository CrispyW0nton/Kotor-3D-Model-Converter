...
const NativeFunctionImplementation& filewriterport_write_bytes_line_13_386e4596_native() {
    static const NativeFunctionImplementation implementation = {
        "GhostRigger.Ports",
        "ghostrigger::ports::core::ports::files",
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Ports","namespace":"ghostrigger::ports::core::ports::files","python_file":"src/core/ports/files.py","qualname":"FileWriterPort.write_bytes","name":"write_bytes","callable_type":"instance_methods","line":13,"end_line":14,"signature":{"args":["self","path","data"],"positional_count":3,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
...
const NativeFunctionImplementation& filewriterport_write_text_line_16_f4a4863f_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Ports","namespace":"ghostrigger::ports::core::ports::files","python_file":"src/core/ports/files.py","qualname":"FileWriterPort.write_text","name":"write_text","callable_type":"instance_methods","line":16,"end_line":17,"signature":{"args":["self","path","text","encoding"],"positional_count":3,"keyword_only_count":1,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
...
const NativeFunctionImplementation& scriptcompilerport_compile_script_line_27_6df94b86_native() {
    static const NativeFunctionImplementation implementation = {
        "GhostRigger.Ports",
        "ghostrigger::ports::core::ports::scripts",
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Ports","namespace":"ghostrigger::ports::core::ports::scripts","python_file":"src/core/ports/scripts.py","qualname":"ScriptCompilerPort.compile_script","name":"compile_script","callable_type":"instance_methods","line":27,"end_line":28,"signature":{"args":["self","source","game"],"positional_count":2,"keyword_only_count":1,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
...
const NativeFunctionImplementation& texturedecoder_decode_texture_line_27_e83bd02c_native() {
    static const NativeFunctionImplementation implementation = {
        "GhostRigger.Ports",
        "ghostrigger::ports::core::ports::textures",
