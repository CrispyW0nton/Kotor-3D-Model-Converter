...
- Owner package: `native/GhostRigger.Core.Rendering.Backends.PyGFX`.
...
- Verification: `GhostRigger.Core.Rendering.Backends.PyGFX` `Debug|x64` build, targeted Python package
