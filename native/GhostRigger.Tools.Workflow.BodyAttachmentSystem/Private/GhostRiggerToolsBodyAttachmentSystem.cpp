...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.Workflow.BodyAttachmentSystem",)"
    R"("owner_surface":"Body Attachment System",)"
    R"("owner_package":"native/GhostRigger.Tools.Workflow.BodyAttachmentSystem",)"
...
GR_TOOLS_BODY_ATTACHMENT_SYSTEM_API const char* gr_tools_body_attachment_system_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.Workflow.BodyAttachmentSystem","version":"0.1.0",)"
