...
constexpr const char* kOwnerBoundary =
    R"({"schema":"tools_two_da_browser_owner_boundary.v1","tool_package":"GhostRigger.Tools.TwoDABrowser",)"
    R"("owner_surface":"2DA Browser","owner_package":"native/GhostRigger.Tools.TwoDABrowser",)"
...
constexpr const char* kTableSchema =
    R"({"schema":"tools_two_da_browser_table_schema.v1","tool_package":"GhostRigger.Tools.TwoDABrowser",)"
...
GR_TOOLS_TWO_DA_BROWSER_API const char* gr_tools_two_da_browser_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.TwoDABrowser","version":"0.1.0","phase":"P1 foundation",)"
