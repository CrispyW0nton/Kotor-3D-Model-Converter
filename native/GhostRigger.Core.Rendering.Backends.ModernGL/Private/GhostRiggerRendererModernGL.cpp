...
constexpr const char* kAdapterBridge =
    ...
    R"("renderer_package":"GhostRigger.Core.Rendering.Backends.ModernGL",)"
    R"("contract_package":"GhostRigger.Core.Rendering.Contracts",)"
...
GR_RENDERER_MODERNGL_API const char* gr_renderer_moderngl_capabilities_json() {
    static const char* prefix =
        R"({"name":"GhostRigger.Core.Rendering.Backends.ModernGL","version":"0.1.0",)"
        R"("phase":"P1 foundation","renderer_backend":true,"backend":"moderngl",)"
        R"("diagnostic_only":true,"contract_package":"GhostRigger.Core.Rendering.Contracts",)"
        R"("contract_version":")";
