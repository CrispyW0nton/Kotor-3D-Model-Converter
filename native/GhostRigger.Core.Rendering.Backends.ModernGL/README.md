...
- Owner package: `native/GhostRigger.Core.Rendering.Backends.ModernGL`.
...
- Verification: `GhostRigger.Core.Rendering.Backends.ModernGL` `Debug|x64` build, targeted Python package
