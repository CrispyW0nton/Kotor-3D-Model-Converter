...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Automation.MCP",)"
    R"("source_package":"src/kotormcp",)"
    R"("owner_surface":"MCP validation tools",)"
    R"("owner_package":"native/GhostRigger.Core.Automation.MCP",)"
...
GHOSTRIGGER_KOTOR_MCP_API const char* gr_kotor_mcp_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Automation.MCP","version":"0.1.0",)"
