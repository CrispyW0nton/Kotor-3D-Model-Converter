...
constexpr const char* kOwnerBoundary =
    ...
    R"("window_package":"GhostRigger.Windows.Legacy.Rigging",)"
    R"("owner_surface":"Legacy Rigging Window",)"
    R"("owner_package":"native/GhostRigger.Windows.Legacy.Rigging",)"
...
GR_WINDOWS_LEGACY_RIGGING_WINDOW_API const char* gr_windows_legacy_rigging_window_capabilities_json() {
    return R"({"name":"GhostRigger.Windows.Legacy.Rigging","version":"0.1.0",)"
