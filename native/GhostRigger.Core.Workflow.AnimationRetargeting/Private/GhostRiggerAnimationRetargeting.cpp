...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Workflow.AnimationRetargeting",)"
    R"("source_package":"src/core/animation_retargeting",)"
    R"("owner_surface":"Animation retargeting compatibility",)"
    R"("owner_package":"native/GhostRigger.Core.Workflow.AnimationRetargeting",)"
...
GHOSTRIGGER_ANIMATION_RETARGETING_API const char* gr_animation_retargeting_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Workflow.AnimationRetargeting","version":"0.1.0",)"
