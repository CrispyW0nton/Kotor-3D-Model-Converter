...
namespace ghostrigger::native::nativecore::math::module_layout_math {
...
bool read_vec3(
    const double* value,
    ghostrigger::native::nativecore::math::module_layout_math::Vec3& out_value
) {
    if (value == nullptr) {
        return false;
    }
...
int write_vec3(ghostrigger::native::nativecore::math::module_layout_math::Vec3 value, double* out_value) {
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_module_anchor_relative_position(
    ...
    ghostrigger::native::nativecore::math::module_layout_math::Vec3 room{};
    ghostrigger::native::nativecore::math::module_layout_math::Vec3 anchor_lyt{};
    ghostrigger::native::nativecore::math::module_layout_math::Vec3 anchor_scene{};
    if (!read_vec3(room_lyt_xyz, room) || !read_vec3(anchor_lyt_xyz, anchor_lyt) || !read_vec3(anchor_scene_xyz, anchor_scene)) {
        return 0;
    }
    return write_vec3(
        ghostrigger::native::nativecore::math::module_layout_math::module_anchor_relative_position(
            room,
            anchor_lyt,
            anchor_scene
        ),
