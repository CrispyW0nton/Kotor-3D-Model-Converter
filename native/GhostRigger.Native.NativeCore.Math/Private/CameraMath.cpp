...
namespace ghostrigger::native::nativecore::math::camera_math {
namespace {
...
bool read_vec3(
    const double* value,
    ghostrigger::native::nativecore::math::camera_math::Vec3& out_value
) {
    if (value == nullptr) {
        return false;
    }
...
bool read_quat(
    const double* value,
    ghostrigger::native::nativecore::math::camera_math::Quat& out_value
) {
    if (value == nullptr) {
        return false;
    }
...
int write_vec3(ghostrigger::native::nativecore::math::camera_math::Vec3 value, double* out_value) {
...
int write_quat(ghostrigger::native::nativecore::math::camera_math::Quat value, double* out_value) {
    if (out_value == nullptr) {
        return 0;
    }
    out_value[0] = value.x;
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_camera_normalize_vec3(
    ...
    ghostrigger::native::nativecore::math::camera_math::Vec3 value{};
    if (!read_vec3(value_xyz, value)) {
        return 0;
    }
    return write_vec3(ghostrigger::native::nativecore::math::camera_math::normalize(value), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_camera_cross(
    ...
    ghostrigger::native::nativecore::math::camera_math::Vec3 a{};
    ghostrigger::native::nativecore::math::camera_math::Vec3 b{};
    if (!read_vec3(a_xyz, a) || !read_vec3(b_xyz, b)) {
        return 0;
    }
    return write_vec3(ghostrigger::native::nativecore::math::camera_math::cross(a, b), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_camera_dot(
    ...
    return ghostrigger::native::nativecore::math::camera_math::dot(a, b);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_camera_add(
    ...
    return write_vec3(ghostrigger::native::nativecore::math::camera_math::add(a, b), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_camera_sub(
    ...
    return write_vec3(ghostrigger::native::nativecore::math::camera_math::sub(a, b), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_camera_mul(
    ...
    return write_vec3(ghostrigger::native::nativecore::math::camera_math::mul(value, scalar), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_camera_length(const double* value_xyz) {
    ...
    return ghostrigger::native::nativecore::math::camera_math::length(value);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_camera_normalize_quat(
    ...
    ghostrigger::native::nativecore::math::camera_math::Quat value{};
    if (!read_quat(value_xyzw, value)) {
        return 0;
    }
    return write_quat(ghostrigger::native::nativecore::math::camera_math::normalize_quat(value), out_xyzw);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_camera_multiply_quat(
    ...
    ghostrigger::native::nativecore::math::camera_math::Quat a{};
    ghostrigger::native::nativecore::math::camera_math::Quat b{};
    if (!read_quat(a_xyzw, a) || !read_quat(b_xyzw, b)) {
        return 0;
    }
    return write_quat(ghostrigger::native::nativecore::math::camera_math::multiply_quat(a, b), out_xyzw);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_camera_quat_to_euler_degrees(
    ...
    return write_vec3(ghostrigger::native::nativecore::math::camera_math::quat_to_euler_degrees(value), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_camera_euler_degrees_to_quat(
    ...
    ghostrigger::native::nativecore::math::camera_math::Vec3 euler{};
    if (!read_vec3(euler_xyz, euler)) {
        return 0;
    }
    return write_quat(ghostrigger::native::nativecore::math::camera_math::euler_degrees_to_quat(euler), out_xyzw);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_camera_rotate_vector(
    ...
    ghostrigger::native::nativecore::math::camera_math::Quat rotation{};
    ghostrigger::native::nativecore::math::camera_math::Vec3 value{};
    if (!read_quat(rotation_xyzw, rotation) || !read_vec3(value_xyz, value)) {
        return 0;
    }
    return write_vec3(ghostrigger::native::nativecore::math::camera_math::rotate_vector(rotation, value), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_camera_look_at_quaternion(
    ...
    ghostrigger::native::nativecore::math::camera_math::Vec3 position{};
    ghostrigger::native::nativecore::math::camera_math::Vec3 target{};
    if (!read_vec3(position_xyz, position) || !read_vec3(target_xyz, target)) {
        return 0;
    }
    return write_quat(
        ghostrigger::native::nativecore::math::camera_math::look_at_quaternion(position, target),
        out_xyzw
    );
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_camera_forward(
    ...
    return write_vec3(ghostrigger::native::nativecore::math::camera_math::camera_forward(value), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_camera_focal_length_to_fov(
    ...
    return ghostrigger::native::nativecore::math::camera_math::focal_length_to_fov(
        sensor_width_mm,
        focal_length_mm
    );
}
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_camera_fov_to_focal_length(
    ...
    return ghostrigger::native::nativecore::math::camera_math::fov_to_focal_length(
        sensor_width_mm,
        fov_degrees
    );
}
