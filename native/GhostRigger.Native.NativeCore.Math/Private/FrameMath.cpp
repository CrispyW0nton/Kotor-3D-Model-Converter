...
namespace ghostrigger::native::nativecore::math::frame_math {
namespace {
...
bool read_vec3(
    const double* value,
    ghostrigger::native::nativecore::math::frame_math::Vec3& out_value
) {
    if (value == nullptr) {
        return false;
    }
...
int write_vec3(ghostrigger::native::nativecore::math::frame_math::Vec3 value, double* out_value) {
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_frame_normalize_vec3(
    ...
    ghostrigger::native::nativecore::math::frame_math::Vec3 value{};
    if (!read_vec3(value_xyz, value)) {
        return 0;
    }
    return write_vec3(ghostrigger::native::nativecore::math::frame_math::normalize(value), out_xyz);
}

GR_NATIVE_CORE_MATH_API const char* gr_native_core_math_frame_clean_texture_name(const char* name) {
    thread_local std::string output;
    output = ghostrigger::native::nativecore::math::frame_math::clean_texture_name(name);
    return output.c_str();
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_frame_cross(
    ...
    ghostrigger::native::nativecore::math::frame_math::Vec3 a{};
    ghostrigger::native::nativecore::math::frame_math::Vec3 b{};
    if (!read_vec3(a_xyz, a) || !read_vec3(b_xyz, b)) {
        return 0;
    }
    return write_vec3(ghostrigger::native::nativecore::math::frame_math::cross(a, b), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_frame_dot(
    ...
    return ghostrigger::native::nativecore::math::frame_math::dot(a, b);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_frame_sub(
    ...
    return write_vec3(ghostrigger::native::nativecore::math::frame_math::sub(a, b), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_frame_add(
    ...
    return write_vec3(ghostrigger::native::nativecore::math::frame_math::add(a, b), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_frame_clamp(
    ...
    return ghostrigger::native::nativecore::math::frame_math::clamp(value, low, high);
}
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_frame_lerp(
    ...
    return ghostrigger::native::nativecore::math::frame_math::lerp(a, b, t);
}
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_frame_unwrap_uv(
    ...
    return ghostrigger::native::nativecore::math::frame_math::unwrap_uv(base, other);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_frame_edge_has_seam(
    ...
    return ghostrigger::native::nativecore::math::frame_math::edge_has_seam(a, b) ? 1 : 0;
}
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_frame_vflip_nontiled(
    ...
    return ghostrigger::native::nativecore::math::frame_math::vflip_nontiled(v, texture_height);
}
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_frame_vflip_tiled(
    ...
    return ghostrigger::native::nativecore::math::frame_math::vflip_tiled(v, tile_v, source_height);
}

GR_NATIVE_CORE_MATH_API std::uint32_t gr_native_core_math_frame_float_to_sort_key(double value) {
    return ghostrigger::native::nativecore::math::frame_math::float_to_sort_key(value);
}
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_frame_compute_screen_size_ratio(
    ...
    ghostrigger::native::nativecore::math::frame_math::Vec3 bounds_min{};
    ghostrigger::native::nativecore::math::frame_math::Vec3 bounds_max{};
    ghostrigger::native::nativecore::math::frame_math::Vec3 view_origin{};
    if (!read_vec3(bounds_min_xyz, bounds_min) || !read_vec3(bounds_max_xyz, bounds_max) || !read_vec3(view_origin_xyz, view_origin)) {
        return 1.0;
    }
    return ghostrigger::native::nativecore::math::frame_math::compute_screen_size_ratio(
        bounds_min,
        bounds_max,
        view_origin,
        fov_vertical_rad,
