...
namespace ghostrigger::native::nativecore::math::viewcube_math {
namespace {
...
bool read_vec3(const double* source, ghostrigger::native::nativecore::math::viewcube_math::Vec3& out_value) {
    if (source == nullptr) {
        return false;
    }
...
int write_vec3(const ghostrigger::native::nativecore::math::viewcube_math::Vec3& value, double* out_value) {
...
int write_quat(const ghostrigger::native::nativecore::math::viewcube_math::Quat& value, double* out_value) {
    if (out_value == nullptr) {
        return 0;
    }
    out_value[0] = value.x;
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_viewcube_normalize(
    ...
    ghostrigger::native::nativecore::math::viewcube_math::Vec3 value{};
    if (!read_vec3(value_xyz, value)) {
        return 0;
    }
    return write_vec3(ghostrigger::native::nativecore::math::viewcube_math::normalize(value), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_viewcube_cross(
    ...
    ghostrigger::native::nativecore::math::viewcube_math::Vec3 a{};
    ghostrigger::native::nativecore::math::viewcube_math::Vec3 b{};
    if (!read_vec3(a_xyz, a) || !read_vec3(b_xyz, b)) {
        return 0;
    }
    return write_vec3(ghostrigger::native::nativecore::math::viewcube_math::cross(a, b), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_viewcube_dot(
    ...
    return ghostrigger::native::nativecore::math::viewcube_math::dot(a, b);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_viewcube_azimuth_elevation_from_direction(
    ...
    ghostrigger::native::nativecore::math::viewcube_math::Vec3 direction{};
    if (!read_vec3(direction_xyz, direction)) {
        return 0;
    }
    ghostrigger::native::nativecore::math::viewcube_math::azimuth_elevation_from_direction(
        direction,
        out_azimuth_degrees,
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_viewcube_action_from_view_name(
    ...
    const auto action = ghostrigger::native::nativecore::math::viewcube_math::action_from_view_name(view_name);
    if (out_action == nullptr) {
        return 0;
    }
    *out_action = static_cast<int>(action);
    return action == ghostrigger::native::nativecore::math::viewcube_math::ViewAction::kInvalid ? 0 : 1;
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_viewcube_target_for_action(
    ...
    auto mapped = static_cast<ghostrigger::native::nativecore::math::viewcube_math::ViewAction>(action);
    if (mapped == ghostrigger::native::nativecore::math::viewcube_math::ViewAction::kPerspective ||
        mapped == ghostrigger::native::nativecore::math::viewcube_math::ViewAction::kHome ||
        mapped == ghostrigger::native::nativecore::math::viewcube_math::ViewAction::kInvalid) {
        return 0;
    }
    return ghostrigger::native::nativecore::math::viewcube_math::target_for_action(
        mapped,
        out_azimuth_degrees,
        out_elevation_degrees
    ) ? 1 : 0;
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_viewcube_view_direction_from_angles(
    ...
    double y = 0.0;
    double z = 0.0;
    ghostrigger::native::nativecore::math::viewcube_math::view_direction_from_angles(azimuth, elevation, &x, &y, &z);
    if (out_xyz == nullptr) {
        return 0;
    }
    out_xyz[0] = x;
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_viewcube_camera_basis_from_angles(
    ...
    ghostrigger::native::nativecore::math::viewcube_math::camera_basis_from_angles(
        azimuth,
        elevation,
        out_right_xyz,
        out_up_xyz,
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_viewcube_view_orientation_quaternion(
    ...
    return write_quat(ghostrigger::native::nativecore::math::viewcube_math::view_orientation_quaternion(azimuth, elevation), out_xyzw);
}
