...
namespace ghostrigger::native::nativecore::math::transform_math {
namespace {
...
bool read_vec3(const double* source, ghostrigger::native::nativecore::math::transform_math::Vec3& out_value) {
    if (source == nullptr) {
        return false;
    }
    out_value = ghostrigger::native::nativecore::math::transform_math::as_vec3(source);
    return true;
}

bool read_quat(const double* source, ghostrigger::native::nativecore::math::transform_math::Quat& out_value) {
    if (source == nullptr) {
        return false;
    }
    out_value = {
...
int write_vec3(const ghostrigger::native::nativecore::math::transform_math::Vec3& value, double* out_value) {
...
int write_quat(const ghostrigger::native::nativecore::math::transform_math::Quat& value, double* out_value) {
    if (out_value == nullptr) {
        return 0;
    }
    out_value[0] = value.x;
...
int write_matrix(const ghostrigger::native::nativecore::math::transform_math::Mat4& value, double* out_value) {
    if (out_value == nullptr) {
        return 0;
    }
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_transform_as_vec3(
    ...
    return write_vec3(ghostrigger::native::nativecore::math::transform_math::as_vec3(values), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_transform_normalize(
    ...
    ghostrigger::native::nativecore::math::transform_math::Vec3 value{};
    if (!read_vec3(value_xyz, value)) {
        return 0;
    }
    return write_vec3(ghostrigger::native::nativecore::math::transform_math::normalize(value), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_transform_closest_point_on_ray(
    ...
    ghostrigger::native::nativecore::math::transform_math::Vec3 origin{};
    ghostrigger::native::nativecore::math::transform_math::Vec3 direction{};
    ghostrigger::native::nativecore::math::transform_math::Vec3 point{};
    if (!read_vec3(origin_xyz, origin) || !read_vec3(direction_xyz, direction) || !read_vec3(point_xyz, point)) {
        return 0;
    }
    return write_vec3(
        ghostrigger::native::nativecore::math::transform_math::closest_point_on_ray(
            origin,
            direction,
            point
        ),
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_transform_closest_point_between_rays(
    ...
    ghostrigger::native::nativecore::math::transform_math::Vec3 origin_a{};
    ghostrigger::native::nativecore::math::transform_math::Vec3 direction_a{};
    ghostrigger::native::nativecore::math::transform_math::Vec3 origin_b{};
    ghostrigger::native::nativecore::math::transform_math::Vec3 direction_b{};
    ...
    const auto [closest_a, closest_b] = ghostrigger::native::nativecore::math::transform_math::closest_point_between_rays(
        origin_a,
        direction_a,
        origin_b,
        direction_b
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_transform_screen_space_distance(
    ...
    return ghostrigger::native::nativecore::math::transform_math::screen_space_distance(ax, ay, bx, by);
}
...
GR_NATIVE_CORE_MATH_API double gr_native_core_math_transform_rotation_angle_from_mouse_delta(
    ...
    return ghostrigger::native::nativecore::math::transform_math::rotation_angle_from_mouse_delta(
        start_x,
        start_y,
        x,
        y,
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_transform_axis_quaternion(
    ...
    return write_quat(ghostrigger::native::nativecore::math::transform_math::axis_quaternion(axis, angle), out_xyzw);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_transform_multiply_quaternions(
    ...
    ghostrigger::native::nativecore::math::transform_math::Quat a{};
    ghostrigger::native::nativecore::math::transform_math::Quat b{};
    if (!read_quat(a_xyzw, a) || !read_quat(b_xyzw, b)) {
        return 0;
    }
    return write_quat(ghostrigger::native::nativecore::math::transform_math::multiply_quaternions(a, b), out_xyzw);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_transform_rotate_vector(
    ...
    ghostrigger::native::nativecore::math::transform_math::Quat rotation{};
    ghostrigger::native::nativecore::math::transform_math::Vec3 vector{};
    if (!read_quat(rotation_xyzw, rotation) || !read_vec3(vector_xyz, vector)) {
        return 0;
    }
    return write_vec3(ghostrigger::native::nativecore::math::transform_math::rotate_vector(rotation, vector), out_xyz);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_transform_build_translation_matrix(
    ...
    ghostrigger::native::nativecore::math::transform_math::Vec3 delta{};
    if (!read_vec3(delta_xyz, delta)) {
        return 0;
    }
    return write_matrix(ghostrigger::native::nativecore::math::transform_math::build_translation_matrix(delta), out_matrix);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_transform_build_rotation_matrix(
    ...
    return write_matrix(ghostrigger::native::nativecore::math::transform_math::build_rotation_matrix(axis, angle), out_matrix);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_transform_build_scale_matrix_scalar(
    ...
    return write_matrix(ghostrigger::native::nativecore::math::transform_math::build_scale_matrix_scalar(scale), out_matrix);
}
...
GR_NATIVE_CORE_MATH_API int gr_native_core_math_transform_build_scale_matrix_vector(
    ...
    ghostrigger::native::nativecore::math::transform_math::Vec3 scale{};
    if (!read_vec3(scale_xyz, scale)) {
        return 0;
    }
    return write_matrix(ghostrigger::native::nativecore::math::transform_math::build_scale_matrix_vector(scale), out_matrix);
}
