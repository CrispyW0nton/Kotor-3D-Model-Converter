...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Tools.Special",)"
    R"("source_package":"src/core/special",)"
    R"("owner_surface":"Special-case model support",)"
    R"("owner_package":"native/GhostRigger.Core.Tools.Special",)"
...
GHOSTRIGGER_SPECIAL_API const char* gr_special_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Tools.Special","version":"0.1.0",)"
