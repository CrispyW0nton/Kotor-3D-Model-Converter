...
#include "Tools_ResourceBrowser/GhostRiggerToolsResourceBrowser.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"tools_resource_browser_owner_boundary.v1","tool_package":"GhostRigger.Core.Tools",)"
    R"("owner_surface":"Resource Browser","owner_package":"native/GhostRigger.Core.Tools",)"
...
constexpr const char* kCatalogueSchema =
    R"({"schema":"tools_resource_browser_catalogue_schema.v1","tool_package":"GhostRigger.Core.Tools",)"
...
GR_TOOLS_RESOURCE_BROWSER_API const char* gr_tools_resource_browser_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Tools","version":"0.1.0","phase":"P1 foundation",)"
