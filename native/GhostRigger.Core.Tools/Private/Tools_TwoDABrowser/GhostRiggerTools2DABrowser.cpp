...
#include "Tools_TwoDABrowser/GhostRiggerTools2DABrowser.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"tools_two_da_browser_owner_boundary.v1","tool_package":"GhostRigger.Core.Tools",)"
    R"("owner_surface":"2DA Browser","owner_package":"native/GhostRigger.Core.Tools",)"
...
constexpr const char* kTableSchema =
    R"({"schema":"tools_two_da_browser_table_schema.v1","tool_package":"GhostRigger.Core.Tools",)"
