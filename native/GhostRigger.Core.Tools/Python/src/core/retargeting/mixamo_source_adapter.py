...
MIXAMO_TO_AURORA_CORE: dict[str, tuple[str, str, str]] = {
    ...
    "lefthandindex1": ("index_base", "left", "LaFngrB_g"),
    "lefthandindex3": ("index_tip", "left", "LaFngrT_g"),
    "lefthandmiddle1": ("middle_base", "left", "LbFngrB_g"),
    "lefthandmiddle3": ("middle_tip", "left", "LbFngrT_g"),
    "lefthandring1": ("ring_base", "left", "LcFngrB_g"),
    "lefthandring3": ("ring_tip", "left", "LcFngrT_g"),
    "lefthandpinky1": ("pinky_base", "left", "LdFngrB_g"),
    "lefthandpinky3": ("pinky_tip", "left", "LdFngrT_g"),
    "lefthandthumb1": ("thumb_base", "left", "LThumbB_g"),
    "lefthandthumb3": ("thumb_tip", "left", "LThumbT_g"),
    ...
    "righthandindex1": ("index_base", "right", "RaFngrB_g"),
    "righthandindex3": ("index_tip", "right", "RaFngrT_g"),
    "righthandmiddle1": ("middle_base", "right", "RbFngrB_g"),
    "righthandmiddle3": ("middle_tip", "right", "RbFngrT_g"),
    "righthandring1": ("ring_base", "right", "RcFngrB_g"),
    "righthandring3": ("ring_tip", "right", "RcFngrT_g"),
    "righthandpinky1": ("pinky_base", "right", "RdFngrB_g"),
    "righthandpinky3": ("pinky_tip", "right", "RdFngrT_g"),
    "righthandthumb1": ("thumb_base", "right", "RThumbB_g"),
    "righthandthumb3": ("thumb_tip", "right", "RThumbT_g"),
