...
namespace ghostrigger::domain::core::sequence::core::sequence::contracts {
namespace {
...
__declspec(dllexport) const char* gr_sequence_interpolation_mode(const char* mode) {
    return ghostrigger::domain::core::sequence::core::sequence::contracts::normalize_interpolation_mode(mode);
}

__declspec(dllexport) double gr_sequence_ease(double t, const char* mode) {
    return ghostrigger::domain::core::sequence::core::sequence::contracts::ease(t, mode);
}

__declspec(dllexport) double gr_sequence_lerp_number(double a, double b, double t) {
    return ghostrigger::domain::core::sequence::core::sequence::contracts::lerp_number(a, b, t);
}

__declspec(dllexport) double gr_sequence_interpolate_number(double a, double b, double t, const char* mode) {
    return ghostrigger::domain::core::sequence::core::sequence::contracts::interpolate_number(a, b, t, mode);
}

__declspec(dllexport) int gr_sequence_interpolate_bool(int a, int b, double t, const char* mode) {
    return ghostrigger::domain::core::sequence::core::sequence::contracts::interpolate_bool(a, b, t, mode);
}

__declspec(dllexport) int gr_sequence_clamp_frame(int frame, int start_frame, int end_frame) {
    return ghostrigger::domain::core::sequence::core::sequence::contracts::clamp_frame(frame, start_frame, end_frame);
}

__declspec(dllexport) double gr_sequence_frame_to_seconds(int frame, int start_frame, double frame_rate) {
    return ghostrigger::domain::core::sequence::core::sequence::contracts::frame_to_seconds(frame, start_frame, frame_rate);
}

__declspec(dllexport) int gr_sequence_seconds_to_frame(double seconds, int start_frame, int end_frame, double frame_rate) {
    return ghostrigger::domain::core::sequence::core::sequence::contracts::seconds_to_frame(seconds, start_frame, end_frame, frame_rate);
}

__declspec(dllexport) int gr_sequence_duration_frames(int start_frame, int end_frame) {
    return ghostrigger::domain::core::sequence::core::sequence::contracts::duration_frames(start_frame, end_frame);
}

__declspec(dllexport) double gr_sequence_duration_seconds(int start_frame, int end_frame, double frame_rate) {
    return ghostrigger::domain::core::sequence::core::sequence::contracts::duration_seconds(start_frame, end_frame, frame_rate);
}

__declspec(dllexport) const char* gr_sequence_contracts_schema_json() {
    return ghostrigger::domain::core::sequence::core::sequence::contracts::sequence_contracts_schema_json();
}
