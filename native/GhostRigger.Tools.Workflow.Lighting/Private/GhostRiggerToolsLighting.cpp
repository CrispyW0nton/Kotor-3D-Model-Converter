...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.Workflow.Lighting",)"
    R"("owner_surface":"Lighting",)"
    R"("owner_package":"native/GhostRigger.Tools.Workflow.Lighting",)"
...
GR_TOOLS_LIGHTING_API const char* gr_tools_lighting_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.Workflow.Lighting","version":"0.1.0",)"
