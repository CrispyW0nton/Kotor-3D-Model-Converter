...
#include "GhostRiggerWorkbench.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"workbench_owner_boundary.v1",)"
    R"("module_package":"GhostRigger.Domain.Core.Workbench",)"
    R"("source_package":"src/workbench",)"
    R"("owner_surface":"Workbench helpers",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Workbench",)"
...
constexpr const char* kDependencySchema =
    R"({"schema":"workbench_dependency_schema.v1",)"
    R"("module_package":"GhostRigger.Domain.Core.Workbench",)"
    R"("source_package":"src/workbench",)"
    R"("diagnostic_only":true,)"
...
GHOSTRIGGER_WORKBENCH_API const char* gr_workbench_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Workbench","version":"0.1.0",)"
           R"("phase":"P1 module sweep","module_package":true,)"
           R"("source_package":"src/workbench",)"
           R"("owner_surface":"Workbench helpers","bridge_method":"C ABI DLL",)"
