...
_NATIVE_RENDERING_DLL = "GhostRigger.Domain.Core.Rendering.dll"
    ...
    if platform.system().lower() == "windows":
        ...
        candidates.extend(
            [
                ...
                root / "native" / "GhostRigger.Domain.Core.Rendering" / "bin" / "x64" / "Release" / _NATIVE_RENDERING_DLL,
                root / "native" / "GhostRigger.Domain.Core.Rendering" / "bin" / "x64" / "Debug" / _NATIVE_RENDERING_DLL,
            ]
        )
