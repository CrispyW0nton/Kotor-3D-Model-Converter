...
namespace rendering_contracts = ghostrigger::domain::core::rendering::core::rendering::rendering_contracts;
...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Rendering",)"
    R"("source_package":"src/core/rendering",)"
    R"("owner_surface":"Renderer-neutral core services",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Rendering",)"
...
GHOSTRIGGER_RENDERING_API const char* gr_rendering_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Rendering","version":"0.1.0",)"
