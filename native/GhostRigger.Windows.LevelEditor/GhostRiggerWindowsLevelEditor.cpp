...
constexpr const char* kOwnerBoundary =
    ...
    R"("window_package":"GhostRigger.Windows.LevelEditor",)"
    R"("owner_surface":"Level Editor",)"
    R"("owner_package":"native/GhostRigger.Windows.LevelEditor",)"
...
GR_WINDOWS_LEVEL_EDITOR_API const char* gr_windows_level_editor_capabilities_json() {
    return R"({"name":"GhostRigger.Windows.LevelEditor","version":"0.1.0",)"
