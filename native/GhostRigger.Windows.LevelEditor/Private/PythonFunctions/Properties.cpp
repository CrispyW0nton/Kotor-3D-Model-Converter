...
const NativeFunctionImplementation& moduleeditorwindow_project_line_64_2e88ed80_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Windows.LevelEditor","namespace":"ghostrigger::windows::leveleditor::gui::windows::module_editor_window","python_file":"src/gui/windows/module_editor_window.py","qualname":"ModuleEditorWindow.project","name":"project","callable_type":"properties","line":64,"end_line":65,"signature":{"args":["self"],"positional_count":1,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
