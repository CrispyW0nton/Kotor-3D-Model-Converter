...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Adapters.Scripting",)"
    R"("source_package":"src/adapters/scripts",)"
    R"("owner_surface":"Script adapters",)"
    R"("owner_package":"native/GhostRigger.Adapters.Scripting",)"
...
GHOSTRIGGER_ADAPTERS_SCRIPTS_API const char* gr_adapters_scripts_capabilities_json() {
    return R"({"name":"GhostRigger.Adapters.Scripting","version":"0.1.0",)"
