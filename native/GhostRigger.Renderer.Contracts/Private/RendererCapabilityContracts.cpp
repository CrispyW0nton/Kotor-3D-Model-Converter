...
GR_RENDERER_CONTRACTS_API const char* gr_renderer_contracts_normalize_display_mode(const char* value) {
    ...
    mode = ghostrigger::renderer::contracts::normalize_display_mode(value);
    return mode.c_str();
}
...
GR_RENDERER_CONTRACTS_API const char* gr_renderer_contracts_moderngl_display_modes_json() {
    ...
    modes = string_array_json(ghostrigger::renderer::contracts::moderngl_display_modes());
    return modes.c_str();
}

GR_RENDERER_CONTRACTS_API const char* gr_renderer_contracts_wgpu_display_modes_json() {
    static thread_local std::string modes;
    modes = string_array_json(ghostrigger::renderer::contracts::wgpu_display_modes());
    return modes.c_str();
}
...
GR_RENDERER_CONTRACTS_API const char* gr_renderer_contracts_wgpu_fallback_display_modes_json() {
    ...
    fallbacks = ghostrigger::renderer::contracts::wgpu_fallback_display_modes_json();
    return fallbacks.c_str();
}

GR_RENDERER_CONTRACTS_API const char* gr_renderer_contracts_diagnostic_display_modes_json() {
    static thread_local std::string modes;
    modes = string_array_json(ghostrigger::renderer::contracts::diagnostic_display_modes());
    return modes.c_str();
}
...
GR_RENDERER_CONTRACTS_API const char* gr_renderer_contracts_status_text(
    ...
    status = ghostrigger::renderer::contracts::status_text(available != 0, diagnostic_only != 0, reason);
    return status.c_str();
}
...
GR_RENDERER_CONTRACTS_API int gr_renderer_contracts_supports_display_mode(
    ...
    return ghostrigger::renderer::contracts::supports_display_mode(
        available != 0,
        diagnostic_only != 0,
        supported_modes,
        mode
