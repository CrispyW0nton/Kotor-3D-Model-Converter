...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Ports",)"
    R"("source_package":"src/core/ports",)"
    R"("owner_surface":"Core port contracts",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Ports",)"
...
GHOSTRIGGER_PORTS_API const char* gr_ports_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Ports","version":"0.1.0",)"
