...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.GUI.Boundary.SequenceEditor",)"
    R"("source_package":"src/gui/sequence_editor",)"
    R"("owner_surface":"GUI sequence editor",)"
    R"("owner_package":"native/GhostRigger.GUI.Boundary.SequenceEditor",)"
...
GHOSTRIGGER_GUI_SEQUENCE_EDITOR_API const char* gr_gui_sequence_editor_capabilities_json() {
    return R"({"name":"GhostRigger.GUI.Boundary.SequenceEditor","version":"0.1.0",)"
