...
from ..game.kotor_loader import load_model_from_bytes, load_model_from_file
...
class MDLBinaryParser:
    ...
    def parse(self) -> Optional[KotorModel]:
        ...
        """
        from ..game.kotor_loader import _is_xbox_from_bytes
    ...
    def _parse_mesh(self, node, gr) -> None:
        ...
        """
        from ..game.kotor_loader import _read_mesh, _read_dangly
    ...
    def _parse_controllers(self, node, gr) -> None:
        ...
        """
        from ..game.kotor_loader import _read_controllers
    ...
    def _parse_one_animation(self, pk_anim) -> Optional[Animation]:
        ...
        """
        from ..game.kotor_loader import _convert_anim
    ...
    def _parse_skin(self, node, gr) -> None:
        ...
        """
        from ..game.kotor_loader import _read_skin_textures, _read_skin_weights
    ...
    def _parse_dangly(self, node, gr) -> None:
        ...
        """
        from ..game.kotor_loader import _read_dangly
        mesh_obj = getattr(node, 'mesh', None)
        if mesh_obj is not None:
            _read_dangly(mesh_obj, gr)
    ...
    def _parse_node(self, pk_node, parent, id_to_pknode) -> 'ModelNode':
        ...
        """
        from ..game.kotor_loader import _convert_node
    ...
    def _apply_bind_pose_controllers(model: KotorModel) -> None:
        ...
        """
        from ..game.kotor_loader import _apply_bind_pose
        _apply_bind_pose(model)

    @staticmethod
    def _generate_missing_normals(model: KotorModel) -> None:
        from ..game.kotor_loader import _fill_missing_normals
...
class MDLAsciiParser:
    ...
    def parse(self, lines: List[str]) -> KotorModel:
        ...
        from ..game.kotor_loader import _fill_missing_normals, _apply_bind_pose
        _fill_missing_normals(model)
        _apply_bind_pose(model)
        return model
    ...
    def _parse_anim_block(self, anim_name: str) -> 'Animation':
        ...
        from ..geometry.model_data import Animation, AnimEvent
    ...
    def _parse_node_block(self, type_str: str, name: str) -> ModelNode:
        ...
        while self._pos < len(self._lines):
            ...
            if cmd == 'endnode':
                ...
                from ..geometry.model_data import VertexSkinData, BoneWeight
                count = int(t[1]); self._pos+=1
                bone_name_to_idx = {}
                bone_compact = []
