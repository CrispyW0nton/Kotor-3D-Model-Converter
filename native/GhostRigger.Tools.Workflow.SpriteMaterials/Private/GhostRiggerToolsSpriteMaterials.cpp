...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.Workflow.SpriteMaterials",)"
    R"("owner_surface":"Sprite Materials",)"
    R"("owner_package":"native/GhostRigger.Tools.Workflow.SpriteMaterials",)"
...
GR_TOOLS_SPRITE_MATERIALS_API const char* gr_tools_sprite_materials_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.Workflow.SpriteMaterials","version":"0.1.0",)"
