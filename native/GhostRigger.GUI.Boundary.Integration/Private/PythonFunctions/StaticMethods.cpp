...
const NativeFunctionImplementation& qtmatrixpanel_normalize_crop_line_149_67abe9b7_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.GUI.Boundary.Integration","namespace":"ghostrigger::gui::boundary::integration::assets::qt_matrix_background","python_file":"src/gui/assets/qt_matrix_background.py","qualname":"QtMatrixPanel._normalize_crop","name":"_normalize_crop","callable_type":"static_methods","line":149,"end_line":158,"signature":{"args":["crop"],"positional_count":1,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
