...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.GUI.Boundary.Integration",)"
    R"("source_package":"src/gui/integration",)"
    R"("owner_surface":"GUI integration services",)"
    R"("owner_package":"native/GhostRigger.GUI.Boundary.Integration",)"
...
GHOSTRIGGER_GUI_INTEGRATION_API const char* gr_gui_integration_capabilities_json() {
    return R"({"name":"GhostRigger.GUI.Boundary.Integration","version":"0.1.0",)"
