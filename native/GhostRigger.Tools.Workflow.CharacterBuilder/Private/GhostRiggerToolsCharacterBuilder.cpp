...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.Workflow.CharacterBuilder",)"
    R"("owner_surface":"Character Studio",)"
    R"("owner_package":"native/GhostRigger.Tools.Workflow.CharacterBuilder",)"
...
GR_TOOLS_CHARACTER_BUILDER_API const char* gr_tools_character_builder_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.Workflow.CharacterBuilder","version":"0.1.0",)"
