...
namespace workflow_base = ghostrigger::workflow::core::workflow::workflow_base;
...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Workflow",)"
    R"("source_package":"src/core/workflow",)"
    R"("owner_surface":"Workflow orchestration",)"
    R"("owner_package":"native/GhostRigger.Workflow",)"
...
GHOSTRIGGER_WORKFLOW_API const char* gr_workflow_capabilities_json() {
    return R"({"name":"GhostRigger.Workflow","version":"0.1.0",)"
