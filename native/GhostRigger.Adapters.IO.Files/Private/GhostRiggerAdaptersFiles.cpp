...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Adapters.IO.Files",)"
    R"("source_package":"src/adapters/files",)"
    R"("owner_surface":"File adapters",)"
    R"("owner_package":"native/GhostRigger.Adapters.IO.Files",)"
...
GHOSTRIGGER_ADAPTERS_FILES_API const char* gr_adapters_files_capabilities_json() {
    return R"({"name":"GhostRigger.Adapters.IO.Files","version":"0.1.0",)"
