...
#include "GhostRiggerAdaptersRendering.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"adapters_rendering_owner_boundary.v1",)"
    R"("module_package":"GhostRigger.Adapters.Rendering.Core",)"
    R"("source_package":"src/adapters/rendering",)"
    R"("owner_surface":"Renderer adapter layer",)"
    R"("owner_package":"native/GhostRigger.Adapters.Rendering.Core",)"
...
constexpr const char* kDependencySchema =
    R"({"schema":"adapters_rendering_dependency_schema.v1",)"
    R"("module_package":"GhostRigger.Adapters.Rendering.Core",)"
    R"("source_package":"src/adapters/rendering",)"
    R"("diagnostic_only":false,)"
...
GHOSTRIGGER_ADAPTERS_RENDERING_API const char* gr_adapters_rendering_capabilities_json() {
    return R"({"name":"GhostRigger.Adapters.Rendering.Core","version":"0.1.0",)"
           R"("phase":"P2 native completion","module_package":true,)"
           R"("source_package":"src/adapters/rendering",)"
           R"("owner_surface":"Renderer adapter layer","bridge_method":"C ABI DLL",)"
