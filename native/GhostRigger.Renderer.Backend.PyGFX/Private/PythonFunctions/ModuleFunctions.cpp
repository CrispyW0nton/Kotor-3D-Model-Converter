...
const NativeFunctionImplementation& gpu_runtime_imported_line_26_47280230_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        "ghostrigger::renderer::backend::pygfx::adapters::rendering::pygfx_core::backend_env",
...
const NativeFunctionImplementation& probe_script_line_73_458ebad6_native() {
    static const NativeFunctionImplementation implementation = {
        "GhostRigger.Renderer.Backend.PyGFX",
        "ghostrigger::renderer::backend::pygfx::adapters::rendering::wgpu_core::shared",
...
const NativeFunctionImplementation& getattr_line_35_3a809ba4_native() {
    static const NativeFunctionImplementation implementation = {
        "GhostRigger.Renderer.Backend.PyGFX",
        "ghostrigger::renderer::backend::pygfx::adapters::rendering::wgpu_renderer_exports",
...
const NativeFunctionImplementation& dir_line_45_972c5fdd_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Renderer.Backend.PyGFX","namespace":"ghostrigger::renderer::backend::pygfx::adapters::rendering::wgpu_renderer_exports","python_file":"src/adapters/rendering/wgpu_renderer_exports.py","qualname":"__dir__","name":"__dir__","callable_type":"module_functions","line":45,"end_line":46,"signature":{"args":[],"positional_count":0,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
...
const NativeFunctionImplementation& load_mesh_shader_line_6_2d673ba0_native() {
    static const NativeFunctionImplementation implementation = {
        "GhostRigger.Renderer.Backend.PyGFX",
        "ghostrigger::renderer::backend::pygfx::core::rendering::wgpu_shaders",
...
const NativeFunctionImplementation& rgb_float_line_127_9d78f9a4_native() {
    static const NativeFunctionImplementation implementation = {
        "GhostRigger.Renderer.Backend.PyGFX",
        "ghostrigger::renderer::backend::pygfx::core::rendering::wgpu_shared",
