...
_NATIVE_VALIDATION_DLL = "GhostRigger.Validation.dll"
    ...
    if platform.system().lower() == "windows":
        ...
        candidates.extend(
            [
                ...
                root / "native" / "GhostRigger.Validation" / "bin" / "x64" / "Release" / _NATIVE_VALIDATION_DLL,
                root / "native" / "GhostRigger.Validation" / "bin" / "x64" / "Debug" / _NATIVE_VALIDATION_DLL,
            ]
        )
