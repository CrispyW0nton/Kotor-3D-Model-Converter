...
- Owner package: `native/GhostRigger.Tools.Workflow.TwoDABrowser`.
...
- Verification: `GhostRigger.Tools.Workflow.TwoDABrowser` `Debug|x64` build, targeted Python package
