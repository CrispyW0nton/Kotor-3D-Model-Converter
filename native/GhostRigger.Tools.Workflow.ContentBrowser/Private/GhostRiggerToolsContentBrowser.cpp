...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.Workflow.ContentBrowser",)"
    R"("owner_surface":"Content Browser",)"
    R"("owner_package":"native/GhostRigger.Tools.Workflow.ContentBrowser",)"
...
GR_TOOLS_CONTENT_BROWSER_API const char* gr_tools_content_browser_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.Workflow.ContentBrowser","version":"0.1.0",)"
