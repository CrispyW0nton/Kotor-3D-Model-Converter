...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.IO.File.Conversion",)"
    R"("source_package":"src/converters",)"
    R"("owner_surface":"Asset converters",)"
    R"("owner_package":"native/GhostRigger.Core.IO.File.Conversion",)"
...
GHOSTRIGGER_CONVERTERS_API const char* gr_converters_capabilities_json() {
    return R"({"name":"GhostRigger.Core.IO.File.Conversion","version":"0.1.0",)"
