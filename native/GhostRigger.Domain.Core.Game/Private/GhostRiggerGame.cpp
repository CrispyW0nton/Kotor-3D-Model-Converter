...
namespace resource_types = ghostrigger::domain::core::game::core::game::resource_types;
...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Game",)"
    R"("source_package":"src/core/game",)"
    R"("owner_surface":"Game-domain services",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Game",)"
...
GHOSTRIGGER_GAME_API const char* gr_game_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Game","version":"0.1.0",)"
