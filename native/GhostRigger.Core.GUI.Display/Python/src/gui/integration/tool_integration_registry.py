...
_DEFAULT_TOOLS = (
    ...
    ToolIntegrationInfo("blueprint_editor", "Blueprint & GFF Editor...", "QtScriptingDialogueStudioWindow", "Tools menu", supported_renderers=_ALL_RENDERERS, null_supported=True),
