...
class ThemeLoader:
    ...
    def _derive_missing_colors(colors: dict[str, str], explicit: set[str]) -> None:
        ...
        fill("axis.x", colors.get("error", "#C93434"))
        fill("axis.y", colors.get("success", "#1B8F45"))
        fill("axis.z", colors.get("accent.primary", "#1F6FEB"))
        fill("axis.text", colors.get("selection.text", "#FFFFFF"))
