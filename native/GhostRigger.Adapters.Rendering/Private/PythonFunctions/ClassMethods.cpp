...
const char* src_adapters_rendering_moderngl_renderer_impl_gpurenderer_is_sprite_hilt_line_2650_5adc72a0_descriptor_json() {
    return R"grjson({"schema":"ghostrigger.phase15.python_function_migration.v1","project":"GhostRigger.Adapters.Rendering","python_module":"src.adapters.rendering.moderngl_renderer_impl","python_file":"src/adapters/rendering/moderngl_renderer_impl.py","qualname":"GpuRenderer._is_sprite_hilt","name":"_is_sprite_hilt","kind":"class_methods","line":2650,"end_line":2662,"signature":{"args":["cls","node"],"positional_count":2,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_status":"migration_stub","python_fallback_required":true,"heavy_cpp_candidate":true})grjson";
}
...
const char* src_adapters_rendering_moderngl_renderer_impl_gpurenderer_sprite_alpha_source_line_2665_2b8129c9_descriptor_json() {
    return R"grjson({"schema":"ghostrigger.phase15.python_function_migration.v1","project":"GhostRigger.Adapters.Rendering","python_module":"src.adapters.rendering.moderngl_renderer_impl","python_file":"src/adapters/rendering/moderngl_renderer_impl.py","qualname":"GpuRenderer._sprite_alpha_source","name":"_sprite_alpha_source","kind":"class_methods","line":2665,"end_line":2674,"signature":{"args":["cls","node"],"positional_count":2,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_status":"migration_stub","python_fallback_required":true,"heavy_cpp_candidate":true})grjson";
}

const char* src_adapters_rendering_moderngl_renderer_impl_gpurenderer_sprite_glow_line_2677_fe0a0901_descriptor_json() {
    return R"grjson({"schema":"ghostrigger.phase15.python_function_migration.v1","project":"GhostRigger.Adapters.Rendering","python_module":"src.adapters.rendering.moderngl_renderer_impl","python_file":"src/adapters/rendering/moderngl_renderer_impl.py","qualname":"GpuRenderer._sprite_glow","name":"_sprite_glow","kind":"class_methods","line":2677,"end_line":2687,"signature":{"args":["cls","node"],"positional_count":2,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_status":"migration_stub","python_fallback_required":true,"heavy_cpp_candidate":true})grjson";
}

const char* src_adapters_rendering_native_core_binding_nativeruntimebinding_load_line_703_925af164_descriptor_json() {
    return R"grjson({"schema":"ghostrigger.phase15.python_function_migration.v1","project":"GhostRigger.Adapters.Rendering","python_module":"src.adapters.rendering.native_core.binding","python_file":"src/adapters/rendering/native_core/binding.py","qualname":"NativeRuntimeBinding.load","name":"load","kind":"class_methods","line":703,"end_line":719,"signature":{"args":["cls"],"positional_count":1,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_status":"migration_stub","python_fallback_required":true,"heavy_cpp_candidate":true})grjson";
}
...
const char* src_adapters_rendering_pygfx_core_renderer_pygfxviewportrenderer_probe_availability_line_87_bda39575_descriptor_json() {
    return R"grjson({"schema":"ghostrigger.phase15.python_function_migration.v1","project":"GhostRigger.Adapters.Rendering","python_module":"src.adapters.rendering.pygfx_core.renderer","python_file":"src/adapters/rendering/pygfx_core/renderer.py","qualname":"PygfxViewportRenderer.probe_availability","name":"probe_availability","kind":"class_methods","line":87,"end_line":125,"signature":{"args":["cls"],"positional_count":1,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_status":"migration_stub","python_fallback_required":true,"heavy_cpp_candidate":true})grjson";
}
...
const char* src_adapters_rendering_pygfx_core_scene_bridge_pygfxscenebridge_polyline_to_segments_line_524_5d05e78c_descriptor_json() {
    return R"grjson({"schema":"ghostrigger.phase15.python_function_migration.v1","project":"GhostRigger.Adapters.Rendering","python_module":"src.adapters.rendering.pygfx_core.scene_bridge","python_file":"src/adapters/rendering/pygfx_core/scene_bridge.py","qualname":"PygfxSceneBridge._polyline_to_segments","name":"_polyline_to_segments","kind":"class_methods","line":524,"end_line":531,"signature":{"args":["cls","points"],"positional_count":2,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_status":"migration_stub","python_fallback_required":true,"heavy_cpp_candidate":true})grjson";
}
...
const PythonFunctionDescriptorEntry* classmethods_descriptors(std::size_t& count) {
    static const PythonFunctionDescriptorEntry entries[] = {
        ...
        {"src/adapters/rendering/native_core/binding.py", "NativeRuntimeBinding.load", "class_methods", &src_adapters_rendering_native_core_binding_nativeruntimebinding_load_line_703_925af164_descriptor_json},
