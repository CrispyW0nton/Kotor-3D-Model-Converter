...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Adapters.Rendering",)"
    R"("source_package":"src/adapters/rendering",)"
    R"("owner_surface":"Renderer adapter layer",)"
    R"("owner_package":"native/GhostRigger.Adapters.Rendering",)"
...
GHOSTRIGGER_ADAPTERS_RENDERING_API const char* gr_adapters_rendering_capabilities_json() {
    return R"({"name":"GhostRigger.Adapters.Rendering","version":"0.1.0",)"
