...
constexpr const char* kOwnerBoundary =
    ...
    R"("window_package":"GhostRigger.Core.Tools.ModuleEditor",)"
    R"("owner_surface":"Level Editor",)"
    R"("owner_package":"native/GhostRigger.Core.Tools.ModuleEditor",)"
...
GR_WINDOWS_LEVEL_EDITOR_API const char* gr_windows_level_editor_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Tools.ModuleEditor","version":"0.1.0",)"
