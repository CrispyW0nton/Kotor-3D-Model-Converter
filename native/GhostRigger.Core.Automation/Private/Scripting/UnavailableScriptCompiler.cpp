#include "Scripting/UnavailableScriptCompiler.h"
...
std::string reason_or_default(const char* reason) {
    ...
    return text.empty() ? ghostrigger::core::automation::scripting::default_unavailable_reason() : text;
}
...
GHOSTRIGGER_CORE_AUTOMATION_SCRIPTING_API const char* gr_core_automation_scripting_unavailable_default_reason() {
    return ghostrigger::core::automation::scripting::default_unavailable_reason();
}
...
GHOSTRIGGER_CORE_AUTOMATION_SCRIPTING_API const char* gr_core_automation_scripting_unavailable_issue_json(
    ...
    issue = ghostrigger::core::automation::scripting::unavailable_validation_issue_json(source, game, reason);
    return issue.c_str();
}
...
GHOSTRIGGER_CORE_AUTOMATION_SCRIPTING_API const char* gr_core_automation_scripting_unavailable_compile_result_json(
    ...
    result = ghostrigger::core::automation::scripting::unavailable_compile_result_json(source, game, reason);
    return result.c_str();
}
