...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Diagnostics",)"
    R"("source_package":"src/core/diagnostics",)"
    R"("owner_surface":"Diagnostic services",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Diagnostics",)"
...
GHOSTRIGGER_DIAGNOSTICS_API const char* gr_diagnostics_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Diagnostics","version":"0.1.0",)"
