...
GHOSTRIGGER_CORE_QT_AUTORIG_API int gr_core_qt_autorig_qt_application_running() {
    return ghostrigger::core::qt::autorig::qt_application_running() ? 1 : 0;
}
...
GHOSTRIGGER_CORE_QT_AUTORIG_API const char* gr_core_qt_autorig_run_cloth_preset_dialog(
    ...
    (void)parent;
    return ghostrigger::core::qt::autorig::run_cloth_preset_dialog(
        parent,
        default_preset,
        title,
        message
...
GHOSTRIGGER_CORE_QT_AUTORIG_API int gr_core_qt_autorig_confirm_cloth_action(
    ...
    (void)parent;
    return ghostrigger::core::qt::autorig::confirm_cloth_action(parent, title, message) ? 1 : 0;
}
