...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Math.Camera",)"
    R"("source_package":"src/core/camera",)"
    R"("owner_surface":"Camera services",)"
    R"("owner_package":"native/GhostRigger.Core.Math.Camera",)"
...
GHOSTRIGGER_CAMERA_API const char* gr_camera_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Math.Camera","version":"0.1.0",)"
