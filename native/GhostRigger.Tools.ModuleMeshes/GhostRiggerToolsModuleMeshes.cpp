...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.ModuleMeshes",)"
    R"("owner_surface":"Module Meshes",)"
    R"("owner_package":"native/GhostRigger.Tools.ModuleMeshes",)"
...
GR_TOOLS_MODULE_MESHES_API const char* gr_tools_module_meshes_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.ModuleMeshes","version":"0.1.0",)"
