...
#ifdef GHOSTRIGGER_GUI_VIEWPORTS_EXPORTS
#define GHOSTRIGGER_GUI_VIEWPORTS_API __declspec(dllexport)
#else
#define GHOSTRIGGER_GUI_VIEWPORTS_API __declspec(dllimport)
#endif
