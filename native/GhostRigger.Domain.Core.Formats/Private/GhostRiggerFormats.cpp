...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Formats",)"
    R"("source_package":"src/formats",)"
    R"("owner_surface":"File format services",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Formats",)"
...
GHOSTRIGGER_FORMATS_API const char* gr_formats_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Formats","version":"0.1.0",)"
