...
#include "GhostRiggerGeometry.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"geometry_owner_boundary.v1",)"
    R"("module_package":"GhostRigger.Domain.Core.Geometry",)"
    R"("source_package":"src/core/geometry",)"
    R"("owner_surface":"Geometry services",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Geometry",)"
...
constexpr const char* kDependencySchema =
    R"({"schema":"geometry_dependency_schema.v1",)"
    R"("module_package":"GhostRigger.Domain.Core.Geometry",)"
    R"("source_package":"src/core/geometry",)"
    R"("diagnostic_only":true,)"
...
GHOSTRIGGER_GEOMETRY_API const char* gr_geometry_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Geometry","version":"0.1.0",)"
           R"("phase":"P1 module sweep","module_package":true,)"
           R"("source_package":"src/core/geometry",)"
           R"("owner_surface":"Geometry services","bridge_method":"C ABI DLL",)"
