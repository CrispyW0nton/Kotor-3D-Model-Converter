...
_NATIVE_GIZMO_DLL = "GhostRigger.Core.Gizmo.dll"
...
def _native_gizmo_candidates() -> tuple[Path, ...]:
    ...
    return (
        ...
        root / "native" / "GhostRigger.Core.Gizmo" / "build" / "vs" / "x64" / "Debug" / _NATIVE_GIZMO_DLL,
        root / "native" / "GhostRigger.Core.Gizmo" / "build" / "vs" / "x64" / "Release" / _NATIVE_GIZMO_DLL,
    )
