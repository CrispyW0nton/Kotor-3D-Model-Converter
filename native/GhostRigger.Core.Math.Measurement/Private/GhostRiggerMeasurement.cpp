...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Math.Measurement",)"
    R"("source_package":"src/measurement",)"
    R"("owner_surface":"Measurement and snapping",)"
    R"("owner_package":"native/GhostRigger.Core.Math.Measurement",)"
...
GHOSTRIGGER_MEASUREMENT_API const char* gr_measurement_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Math.Measurement","version":"0.1.0",)"
