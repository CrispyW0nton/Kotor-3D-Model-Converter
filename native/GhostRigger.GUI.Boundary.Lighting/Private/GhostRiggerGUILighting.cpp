...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.GUI.Boundary.Lighting",)"
    R"("source_package":"src/gui/lighting",)"
    R"("owner_surface":"GUI lighting controls",)"
    R"("owner_package":"native/GhostRigger.GUI.Boundary.Lighting",)"
...
GHOSTRIGGER_GUI_LIGHTING_API const char* gr_gui_lighting_capabilities_json() {
    return R"({"name":"GhostRigger.GUI.Boundary.Lighting","version":"0.1.0",)"
