...
- Owner package: `native/GhostRigger.Graphics.Renderer.Backend.ModernGL`.
...
- Verification: `GhostRigger.Graphics.Renderer.Backend.ModernGL` `Debug|x64` build, targeted Python package
