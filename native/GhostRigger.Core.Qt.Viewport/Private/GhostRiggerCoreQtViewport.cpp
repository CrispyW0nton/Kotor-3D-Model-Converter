...
#include "GhostRiggerCoreQtViewport.h"
...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Qt.Viewport",)"
    R"("source_package":"src/adapters/qt_viewport",)"
    R"("owner_surface":"Qt viewport adapters",)"
    R"("owner_package":"native/GhostRigger.Core.Qt.Viewport",)"
...
GHOSTRIGGER_CORE_QT_VIEWPORT_API const char* gr_core_qt_viewport_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Qt.Viewport","version":"0.1.0",)"
