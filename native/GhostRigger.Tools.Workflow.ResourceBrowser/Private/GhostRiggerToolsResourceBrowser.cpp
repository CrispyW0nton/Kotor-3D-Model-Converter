...
constexpr const char* kOwnerBoundary =
    R"({"schema":"tools_resource_browser_owner_boundary.v1","tool_package":"GhostRigger.Tools.Workflow.ResourceBrowser",)"
    R"("owner_surface":"Resource Browser","owner_package":"native/GhostRigger.Tools.Workflow.ResourceBrowser",)"
...
constexpr const char* kCatalogueSchema =
    R"({"schema":"tools_resource_browser_catalogue_schema.v1","tool_package":"GhostRigger.Tools.Workflow.ResourceBrowser",)"
...
GR_TOOLS_RESOURCE_BROWSER_API const char* gr_tools_resource_browser_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.Workflow.ResourceBrowser","version":"0.1.0","phase":"P1 foundation",)"
