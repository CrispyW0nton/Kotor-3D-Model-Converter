...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.GUI.Display.Rendering",)"
    R"("source_package":"src/gui/rendering",)"
    R"("owner_surface":"GUI rendering helpers",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Display.Rendering",)"
...
GHOSTRIGGER_GUI_RENDERING_API const char* gr_gui_rendering_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Display.Rendering","version":"0.1.0",)"
