...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Autorig",)"
    R"("source_package":"src/autorig",)"
    R"("owner_surface":"Auto-rigging services",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Autorig",)"
...
GHOSTRIGGER_AUTORIG_API const char* gr_autorig_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Autorig","version":"0.1.0",)"
