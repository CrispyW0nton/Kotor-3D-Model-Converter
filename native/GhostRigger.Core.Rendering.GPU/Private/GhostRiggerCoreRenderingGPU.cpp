...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Rendering.GPU",)"
    R"("source_package":"src/adapters/gpu",)"
    R"("owner_surface":"GPU adapters",)"
    R"("owner_package":"native/GhostRigger.Core.Rendering.GPU",)"
...
GHOSTRIGGER_CORE_RENDERING_GPU_API const char* gr_core_rendering_gpu_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Rendering.GPU","version":"0.1.0",)"
