...
metadata, and failure-diagnostic metadata, but it does not create a swap chain,
acquire back buffers, create RTVs, present, execute a command list, or create a
draw submission path yet.
