...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.Workflow.NodeSkeletonBrowser",)"
    R"("owner_surface":"Nodes/Skeleton Browser",)"
    R"("owner_package":"native/GhostRigger.Tools.Workflow.NodeSkeletonBrowser",)"
...
GR_TOOLS_NODES_SKELETON_BROWSER_API const char* gr_tools_nodes_skeleton_browser_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.Workflow.NodeSkeletonBrowser","version":"0.1.0",)"
