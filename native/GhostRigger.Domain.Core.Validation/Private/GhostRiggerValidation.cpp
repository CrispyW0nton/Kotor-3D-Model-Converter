...
namespace validation_bus = ghostrigger::domain::core::validation::core::validation::validation_bus;
...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Validation",)"
    R"("source_package":"src/core/validation",)"
    R"("owner_surface":"Validation services",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Validation",)"
...
GHOSTRIGGER_VALIDATION_API const char* gr_validation_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Validation","version":"0.1.0",)"
