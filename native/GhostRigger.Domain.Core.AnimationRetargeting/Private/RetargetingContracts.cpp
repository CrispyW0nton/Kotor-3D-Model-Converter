...
using ghostrigger::domain::core::animationretargeting::core::animation_retargeting::retargeter::Quat;
using ghostrigger::domain::core::animationretargeting::core::animation_retargeting::retargeter::Vec3;
...
GHOSTRIGGER_ANIMATION_RETARGETING_API const char* gr_animation_retargeting_candidate_names_json(
    ...
    json = json_string_array(
        ghostrigger::domain::core::animationretargeting::core::animation_retargeting::retargeter::candidate_names(
...
GHOSTRIGGER_ANIMATION_RETARGETING_API int gr_animation_retargeting_sub3(
    ...
    return write_vec3(ghostrigger::domain::core::animationretargeting::core::animation_retargeting::retargeter::sub3(read_vec3(a_xyz), read_vec3(b_xyz)), out_xyz);
}
...
GHOSTRIGGER_ANIMATION_RETARGETING_API int gr_animation_retargeting_add3(
    ...
    return write_vec3(ghostrigger::domain::core::animationretargeting::core::animation_retargeting::retargeter::add3(read_vec3(a_xyz), read_vec3(b_xyz), scale), out_xyz);
}
...
GHOSTRIGGER_ANIMATION_RETARGETING_API int gr_animation_retargeting_mul3(
    ...
    return write_vec3(ghostrigger::domain::core::animationretargeting::core::animation_retargeting::retargeter::mul3(read_vec3(a_xyz), scale), out_xyz);
}
...
GHOSTRIGGER_ANIMATION_RETARGETING_API int gr_animation_retargeting_normal_quat(
    ...
    return write_quat(ghostrigger::domain::core::animationretargeting::core::animation_retargeting::retargeter::normal_quat(read_quat(q_xyzw)), out_xyzw);
}
...
GHOSTRIGGER_ANIMATION_RETARGETING_API int gr_animation_retargeting_quat_conjugate(
    ...
    return write_quat(ghostrigger::domain::core::animationretargeting::core::animation_retargeting::retargeter::quat_conjugate(read_quat(q_xyzw)), out_xyzw);
}
...
GHOSTRIGGER_ANIMATION_RETARGETING_API int gr_animation_retargeting_quat_mul(
    ...
    return write_quat(ghostrigger::domain::core::animationretargeting::core::animation_retargeting::retargeter::quat_mul(read_quat(a_xyzw), read_quat(b_xyzw)), out_xyzw);
}
...
GHOSTRIGGER_ANIMATION_RETARGETING_API int gr_animation_retargeting_retarget_rotation(
    ...
    return write_quat(
        ghostrigger::domain::core::animationretargeting::core::animation_retargeting::retargeter::retarget_rotation(
...
GHOSTRIGGER_ANIMATION_RETARGETING_API double gr_animation_retargeting_height_from_positions(
    ...
    return ghostrigger::domain::core::animationretargeting::core::animation_retargeting::retargeter::height_from_positions(
        xyz_values,
        point_count
    );
}
