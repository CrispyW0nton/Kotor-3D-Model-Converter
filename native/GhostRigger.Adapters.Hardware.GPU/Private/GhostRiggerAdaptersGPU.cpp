...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Adapters.Hardware.GPU",)"
    R"("source_package":"src/adapters/gpu",)"
    R"("owner_surface":"GPU adapters",)"
    R"("owner_package":"native/GhostRigger.Adapters.Hardware.GPU",)"
...
GHOSTRIGGER_ADAPTERS_GPU_API const char* gr_adapters_gpu_capabilities_json() {
    return R"({"name":"GhostRigger.Adapters.Hardware.GPU","version":"0.1.0",)"
