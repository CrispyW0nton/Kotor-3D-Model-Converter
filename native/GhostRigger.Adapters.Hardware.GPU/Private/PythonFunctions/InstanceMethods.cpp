...
const NativeFunctionImplementation& lightmapbaker_construct_line_13_ea0e7678_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        "ghostrigger::adapters::hardware::gpu::lightmap_baker",
