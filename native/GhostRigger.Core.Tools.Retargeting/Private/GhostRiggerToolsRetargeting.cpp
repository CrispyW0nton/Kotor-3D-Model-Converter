...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Core.Tools.Retargeting",)"
    R"("owner_surface":"Retarget Workbench",)"
    R"("owner_package":"native/GhostRigger.Core.Tools.Retargeting",)"
...
GR_TOOLS_RETARGETING_API const char* gr_tools_retargeting_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Tools.Retargeting","version":"0.1.0",)"
