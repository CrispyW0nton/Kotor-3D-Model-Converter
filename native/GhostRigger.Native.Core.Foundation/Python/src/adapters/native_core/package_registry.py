...
PYTHON_MODULE_PACKAGE_SPECS = (
    NativePackageSpec(
        ...
        name="GhostRigger.Core.IO.MDL",
        dll_name="GhostRigger.Core.IO.MDL.dll",
        ...
        name="GhostRigger.Core.Automation.MCP",
        dll_name="GhostRigger.Core.Automation.MCP.dll",
        ...
        name="GhostRigger.Core.GUI.Helpers.GizmoDisplay",
        dll_name="GhostRigger.Core.GUI.Helpers.GizmoDisplay.dll",
        env_var="GHOSTRIGGER_GUI_GIZMO",
        version_export="gr_gui_gizmo_version",
        capabilities_export="gr_gui_gizmo_capabilities_json",
    ),    NativePackageSpec(
        name="GhostRigger.Core.GUI.Display.Camera",
        dll_name="GhostRigger.Core.GUI.Display.Camera.dll",
