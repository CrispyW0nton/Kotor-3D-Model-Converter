...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Animation",)"
    R"("source_package":"src/core/animation",)"
    R"("owner_surface":"Animation runtime",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Animation",)"
...
GHOSTRIGGER_ANIMATION_API const char* gr_animation_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Animation","version":"0.1.0",)"
