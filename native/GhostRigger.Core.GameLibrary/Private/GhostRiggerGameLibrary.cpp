...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.GameLibrary",)"
    R"("source_package":"src/resources",)"
    R"("owner_surface":"Game library discovery",)"
    R"("owner_package":"native/GhostRigger.Core.GameLibrary",)"
...
GHOSTRIGGER_GAME_LIBRARY_API const char* gr_game_library_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GameLibrary","version":"0.1.0",)"
