...
namespace ghostrigger::adapters::scripts {

const NativeFunctionImplementation& unavailablescriptcompiler_compile_script_line_29_00747c15_native() {
    static const NativeFunctionImplementation implementation = {
        "GhostRigger.Adapters.Scripts",
        "ghostrigger::adapters::scripts::unavailable_compiler",
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Adapters.Scripts","namespace":"ghostrigger::adapters::scripts::unavailable_compiler","python_file":"src/adapters/scripts/unavailable_compiler.py","qualname":"UnavailableScriptCompiler.compile_script","name":"compile_script","callable_type":"instance_methods","line":29,"end_line":46,"signature":{"args":["self","source","game"],"positional_count":2,"keyword_only_count":1,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
