...
#include "GhostRiggerGUICamera.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"gui_camera_owner_boundary.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.Camera",)"
    R"("source_package":"src/gui/camera",)"
    R"("owner_surface":"GUI camera helpers",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Display.Camera",)"
...
constexpr const char* kDependencySchema =
    R"({"schema":"gui_camera_dependency_schema.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.Camera",)"
    R"("source_package":"src/gui/camera",)"
    R"("diagnostic_only":true,)"
...
GHOSTRIGGER_GUI_CAMERA_API const char* gr_gui_camera_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Display.Camera","version":"0.1.0",)"
           R"("phase":"P1 module sweep","module_package":true,)"
           R"("source_package":"src/gui/camera",)"
           R"("owner_surface":"GUI camera helpers","bridge_method":"C ABI DLL",)"
