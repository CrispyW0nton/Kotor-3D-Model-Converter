...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.Workflow.Camera",)"
    R"("owner_surface":"Camera",)"
    R"("owner_package":"native/GhostRigger.Tools.Workflow.Camera",)"
...
GR_TOOLS_CAMERA_API const char* gr_tools_camera_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.Workflow.Camera","version":"0.1.0",)"
