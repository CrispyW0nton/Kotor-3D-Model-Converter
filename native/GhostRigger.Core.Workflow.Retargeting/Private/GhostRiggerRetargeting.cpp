...
namespace retarget_contracts = ghostrigger::core::retargeting::core::retargeting::retarget_contracts;
...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Workflow.Retargeting",)"
    R"("source_package":"src/core/retargeting",)"
    R"("owner_surface":"Retarget Workbench core",)"
    R"("owner_package":"native/GhostRigger.Core.Workflow.Retargeting",)"
...
GHOSTRIGGER_RETARGETING_API const char* gr_retargeting_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Workflow.Retargeting","version":"0.1.0",)"
