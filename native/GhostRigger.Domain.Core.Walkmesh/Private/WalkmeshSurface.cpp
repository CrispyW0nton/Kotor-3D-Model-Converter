...
namespace ghostrigger::domain::core::walkmesh::core::walkmesh::surface {
namespace {
...
__declspec(dllexport) const char* gr_walkmesh_surface_name(int surface_id) {
    return ghostrigger::domain::core::walkmesh::core::walkmesh::surface::surface_name(surface_id);
}
...
__declspec(dllexport) void gr_walkmesh_surface_color(
    ...
    const auto color = ghostrigger::domain::core::walkmesh::core::walkmesh::surface::surface_color(surface_id);
    if (r != nullptr) {
        *r = color.r;
    }
    if (g != nullptr) {
...
__declspec(dllexport) int gr_walkmesh_surface_is_walkable(int surface_id) {
    return ghostrigger::domain::core::walkmesh::core::walkmesh::surface::is_walkable(surface_id) ? 1 : 0;
}

__declspec(dllexport) int gr_walkmesh_surface_is_non_walkable(int surface_id) {
    return ghostrigger::domain::core::walkmesh::core::walkmesh::surface::is_non_walkable(surface_id) ? 1 : 0;
}

__declspec(dllexport) const char* gr_walkmesh_fbx_material_name(int surface_id) {
    return ghostrigger::domain::core::walkmesh::core::walkmesh::surface::fbx_material_name(surface_id);
}
...
__declspec(dllexport) void gr_walkmesh_fbx_material_diffuse(
    ...
    const auto color = ghostrigger::domain::core::walkmesh::core::walkmesh::surface::fbx_material_diffuse(surface_id);
    if (r != nullptr) {
        *r = color.r;
    }
    if (g != nullptr) {
...
__declspec(dllexport) const char* gr_walkmesh_surface_contracts_schema_json() {
    return ghostrigger::domain::core::walkmesh::core::walkmesh::surface::walkmesh_surface_contracts_schema_json();
}
