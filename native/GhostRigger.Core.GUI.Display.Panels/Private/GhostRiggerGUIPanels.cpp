...
#include "GhostRiggerGUIPanels.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"gui_panels_owner_boundary.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.Panels",)"
    R"("source_package":"src/gui/panels",)"
    R"("owner_surface":"GUI panels",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Display.Panels",)"
...
constexpr const char* kDependencySchema =
    R"({"schema":"gui_panels_dependency_schema.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.Panels",)"
    R"("source_package":"src/gui/panels",)"
    R"("diagnostic_only":true,)"
...
GHOSTRIGGER_GUI_PANELS_API const char* gr_gui_panels_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Display.Panels","version":"0.1.0",)"
           R"("phase":"P1 module sweep","module_package":true,)"
           R"("source_package":"src/gui/panels",)"
           R"("owner_surface":"GUI panels","bridge_method":"C ABI DLL",)"
