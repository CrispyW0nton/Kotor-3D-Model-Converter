...
const NativeFunctionImplementation& clothrigpreset_get_line_208_148424dc_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Autorig","namespace":"ghostrigger::autorig::cloth_rig","python_file":"src/autorig/cloth_rig.py","qualname":"ClothRigPreset.get","name":"get","callable_type":"class_methods","line":208,"end_line":214,"signature":{"args":["cls","name"],"positional_count":2,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
