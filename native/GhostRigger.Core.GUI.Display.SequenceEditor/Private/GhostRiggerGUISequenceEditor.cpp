...
#include "GhostRiggerGUISequenceEditor.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"gui_sequence_editor_owner_boundary.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.SequenceEditor",)"
    R"("source_package":"src/gui/sequence_editor",)"
    R"("owner_surface":"GUI sequence editor",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Display.SequenceEditor",)"
...
constexpr const char* kDependencySchema =
    R"({"schema":"gui_sequence_editor_dependency_schema.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.SequenceEditor",)"
    R"("source_package":"src/gui/sequence_editor",)"
    R"("diagnostic_only":true,)"
...
GHOSTRIGGER_GUI_SEQUENCE_EDITOR_API const char* gr_gui_sequence_editor_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Display.SequenceEditor","version":"0.1.0",)"
           R"("phase":"P1 module sweep","module_package":true,)"
           R"("source_package":"src/gui/sequence_editor",)"
           R"("owner_surface":"GUI sequence editor","bridge_method":"C ABI DLL",)"
