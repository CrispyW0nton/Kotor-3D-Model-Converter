...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Core.Tools.Properties",)"
    R"("owner_surface":"Properties",)"
    R"("owner_package":"native/GhostRigger.Core.Tools.Properties",)"
...
GR_TOOLS_PROPERTIES_API const char* gr_tools_properties_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Tools.Properties","version":"0.1.0",)"
