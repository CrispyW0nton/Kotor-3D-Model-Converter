...
namespace ghostrigger::domain::core::infrastructure {

const NativeFunctionImplementation& maybe_autostart_kotormcp_line_17_3a73802a_native() {
    static const NativeFunctionImplementation implementation = {
        "GhostRigger.Domain.Core.Infrastructure",
        "ghostrigger::domain::core::infrastructure::mcp_autostart",
