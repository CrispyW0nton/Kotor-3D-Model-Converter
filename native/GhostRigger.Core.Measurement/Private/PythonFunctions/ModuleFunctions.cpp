...
const NativeFunctionImplementation& quat_to_euler_degrees_line_23_8759ec24_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Core.Measurement","namespace":"ghostrigger::core::measurement::dimension_calculator","python_file":"src/measurement/dimension_calculator.py","qualname":"_quat_to_euler_degrees","name":"_quat_to_euler_degrees","callable_type":"module_functions","line":23,"end_line":40,"signature":{"args":["q"],"positional_count":1,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
