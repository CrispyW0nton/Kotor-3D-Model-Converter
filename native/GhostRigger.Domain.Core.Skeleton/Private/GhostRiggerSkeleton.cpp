...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Skeleton",)"
    R"("source_package":"src/core/skeleton",)"
    R"("owner_surface":"Skeleton services",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Skeleton",)"
...
GHOSTRIGGER_SKELETON_API const char* gr_skeleton_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Skeleton","version":"0.1.0",)"
