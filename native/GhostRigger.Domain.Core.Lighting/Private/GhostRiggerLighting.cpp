...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Lighting",)"
    R"("source_package":"src/core/lighting",)"
    R"("owner_surface":"Lighting and lightmap baking",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Lighting",)"
...
GHOSTRIGGER_LIGHTING_API const char* gr_lighting_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Lighting","version":"0.1.0",)"
