...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.Workflow.ModuleMeshes",)"
    R"("owner_surface":"Module Meshes",)"
    R"("owner_package":"native/GhostRigger.Tools.Workflow.ModuleMeshes",)"
...
GR_TOOLS_MODULE_MESHES_API const char* gr_tools_module_meshes_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.Workflow.ModuleMeshes","version":"0.1.0",)"
