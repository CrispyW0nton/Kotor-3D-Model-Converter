...
namespace retarget_contracts = ghostrigger::domain::core::retargeting::core::retargeting::retarget_contracts;
...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Retargeting",)"
    R"("source_package":"src/core/retargeting",)"
    R"("owner_surface":"Retarget Workbench core",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Retargeting",)"
...
GHOSTRIGGER_RETARGETING_API const char* gr_retargeting_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Retargeting","version":"0.1.0",)"
