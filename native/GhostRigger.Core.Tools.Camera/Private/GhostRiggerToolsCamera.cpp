...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Core.Tools.Camera",)"
    R"("owner_surface":"Camera",)"
    R"("owner_package":"native/GhostRigger.Core.Tools.Camera",)"
...
GR_TOOLS_CAMERA_API const char* gr_tools_camera_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Tools.Camera","version":"0.1.0",)"
