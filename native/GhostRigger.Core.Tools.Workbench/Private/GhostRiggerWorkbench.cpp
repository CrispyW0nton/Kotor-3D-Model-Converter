...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Tools.Workbench",)"
    R"("source_package":"src/workbench",)"
    R"("owner_surface":"Workbench helpers",)"
    R"("owner_package":"native/GhostRigger.Core.Tools.Workbench",)"
...
GHOSTRIGGER_WORKBENCH_API const char* gr_workbench_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Tools.Workbench","version":"0.1.0",)"
