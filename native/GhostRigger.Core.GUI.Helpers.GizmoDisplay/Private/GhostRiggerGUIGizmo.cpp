...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.GUI.Helpers.GizmoDisplay",)"
    R"("source_package":"src/gui/gizmo",)"
    R"("owner_surface":"GUI gizmo helpers",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Helpers.GizmoDisplay",)"
...
GHOSTRIGGER_GUI_GIZMO_API const char* gr_gui_gizmo_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Helpers.GizmoDisplay","version":"0.1.0",)"
