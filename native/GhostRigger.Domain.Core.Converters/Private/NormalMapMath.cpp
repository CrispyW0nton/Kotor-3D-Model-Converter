...
namespace ghostrigger::domain::core::converters::normal_map::math {
...
__declspec(dllexport) void gr_converters_normal_map_normalize3(
    ...
    const auto result = ghostrigger::domain::core::converters::normal_map::math::normalize3({x, y, z});
    if (out_x != nullptr) {
        *out_x = result.x;
    }
    if (out_y != nullptr) {
...
__declspec(dllexport) double gr_converters_normal_map_dot3(
    ...
    return ghostrigger::domain::core::converters::normal_map::math::dot3({ax, ay, az}, {bx, by, bz});
}
...
__declspec(dllexport) int gr_converters_normal_map_barycentric_uv(
    ...
    const auto result = ghostrigger::domain::core::converters::normal_map::math::barycentric_uv(
        u,
        v,
        {uv0_x, uv0_y},
        {uv1_x, uv1_y},
...
__declspec(dllexport) void gr_converters_normal_map_compute_tangent(
    ...
    const auto result = ghostrigger::domain::core::converters::normal_map::math::compute_tangent(
        {v0_x, v0_y, v0_z},
        {v1_x, v1_y, v1_z},
        {v2_x, v2_y, v2_z},
        {uv0_x, uv0_y},
...
__declspec(dllexport) void gr_converters_normal_map_world_to_tangent(
    ...
    const auto result = ghostrigger::domain::core::converters::normal_map::math::world_to_tangent(
...
__declspec(dllexport) int gr_converters_normal_map_ray_triangle_intersect(
    ...
    const auto result = ghostrigger::domain::core::converters::normal_map::math::ray_triangle_intersect(
...
__declspec(dllexport) const char* gr_converters_normal_map_math_contracts_schema_json() {
    return ghostrigger::domain::core::converters::normal_map::math::normal_map_math_contracts_schema_json();
}
