...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Converters",)"
    R"("source_package":"src/converters",)"
    R"("owner_surface":"Asset converters",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Converters",)"
...
GHOSTRIGGER_CONVERTERS_API const char* gr_converters_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Converters","version":"0.1.0",)"
