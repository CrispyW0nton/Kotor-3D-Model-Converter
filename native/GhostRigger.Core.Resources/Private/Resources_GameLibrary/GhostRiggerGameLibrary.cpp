...
#include "Resources_GameLibrary/GhostRiggerGameLibrary.h"
...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Resources",)"
    R"("source_package":"src/resources",)"
    R"("owner_surface":"Game library discovery",)"
    R"("owner_package":"native/GhostRigger.Core.Resources",)"
...
GHOSTRIGGER_GAME_LIBRARY_API const char* gr_game_library_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Resources","version":"0.1.0",)"
