# GhostRigger.Domain.Core.Workflow

Owner surface: Workflow orchestration
Owner package: native/GhostRigger.Domain.Core.Workflow
Source package: src/core/workflow
