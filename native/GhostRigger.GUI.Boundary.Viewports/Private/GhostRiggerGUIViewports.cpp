...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.GUI.Boundary.Viewports",)"
    R"("source_package":"src/gui/viewports",)"
    R"("owner_surface":"GUI viewport widgets",)"
    R"("owner_package":"native/GhostRigger.GUI.Boundary.Viewports",)"
...
GHOSTRIGGER_GUI_VIEWPORTS_API const char* gr_gui_viewports_capabilities_json() {
    return R"({"name":"GhostRigger.GUI.Boundary.Viewports","version":"0.1.0",)"
