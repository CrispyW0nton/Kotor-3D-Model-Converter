...
__declspec(dllexport) const char* gr_project_resource_address_supported_schemes_json() {
    static const std::string schemes = ghostrigger::project::core::project::resource_address::supported_schemes_json();
    return schemes.c_str();
}

__declspec(dllexport) int gr_project_resource_address_is_supported_scheme(const char* scheme) {
    return ghostrigger::project::core::project::resource_address::is_supported_scheme(
        std::string(scheme == nullptr ? "" : scheme)
    ) ? 1 : 0;
}
...
__declspec(dllexport) const char* gr_project_resource_address_stable_key(
    ...
    result = ghostrigger::project::core::project::resource_address::make_address_from_c_args(
        scheme,
        game,
        module_id,
        resref,
...
__declspec(dllexport) const char* gr_project_resource_address_contracts_schema_json() {
    return ghostrigger::project::core::project::resource_address::resource_address_contracts_schema_json();
}
