...
constexpr const char* kOwnerBoundary =
    ...
    R"("window_package":"GhostRigger.Core.Tools.Retargeting.Workbench",)"
    R"("owner_surface":"Animation Retarget Workbench",)"
    R"("owner_package":"native/GhostRigger.Core.Tools.Retargeting.Workbench",)"
...
GR_WINDOWS_ANIMATION_RETARGET_WORKBENCH_API const char* gr_windows_animation_retarget_workbench_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Tools.Retargeting.Workbench","version":"0.1.0",)"
