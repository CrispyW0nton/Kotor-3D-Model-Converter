...
namespace axis_mode = ghostrigger::domain::core::scene::core::scene::axis_mode;
namespace scene_primitives = ghostrigger::domain::core::scene::core::scene::scene_primitives;
...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Scene",)"
    R"("source_package":"src/core/scene",)"
    R"("owner_surface":"Main Viewport / KMAX scene services",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Scene",)"
...
GHOSTRIGGER_SCENE_API const char* gr_scene_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Scene","version":"0.1.0",)"
