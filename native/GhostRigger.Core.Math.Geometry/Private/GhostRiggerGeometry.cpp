...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Math.Geometry",)"
    R"("source_package":"src/core/geometry",)"
    R"("owner_surface":"Geometry services",)"
    R"("owner_package":"native/GhostRigger.Core.Math.Geometry",)"
...
GHOSTRIGGER_GEOMETRY_API const char* gr_geometry_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Math.Geometry","version":"0.1.0",)"
