...
constexpr const char* kOwnerBoundary =
    ...
    R"("window_package":"GhostRigger.Core.Tools.UnrealAnimator",)"
    R"("owner_surface":"Unreal Animator Window",)"
    R"("owner_package":"native/GhostRigger.Core.Tools.UnrealAnimator",)"
...
GR_WINDOWS_UNREAL_ANIMATOR_WINDOW_API const char* gr_windows_unreal_animator_window_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Tools.UnrealAnimator","version":"0.1.0",)"
