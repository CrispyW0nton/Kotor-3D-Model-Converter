...
#include "GhostRiggerWindowsUnrealAnimatorWindow.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"windows_unreal_animator_window_owner_boundary.v1",)"
    R"("window_package":"GhostRigger.Windows.Workbench.UnrealAnimator",)"
    R"("owner_surface":"Unreal Animator Window",)"
    R"("owner_package":"native/GhostRigger.Windows.Workbench.UnrealAnimator",)"
    R"("bridge_method":"C ABI DLL",)"
    R"("diagnostic_only":true,)"
    R"("cpp_owns":["unreal_animator_host_service_metadata","native_command_routing_metadata","window_diagnostics"],)"
    R"("python_owns":["qt_widgets","unreal_animator_workflow","docks","menus","themes","layouts","visible_window_state"],)"
    R"("native_shell_enabled":false})";
constexpr const char* kHostServiceSchema =
    R"({"schema":"windows_unreal_animator_window_host_service_schema.v1",)"
    R"("window_package":"GhostRigger.Windows.Workbench.UnrealAnimator",)"
...
GR_WINDOWS_UNREAL_ANIMATOR_WINDOW_API const char* gr_windows_unreal_animator_window_capabilities_json() {
    return R"({"name":"GhostRigger.Windows.Workbench.UnrealAnimator","version":"0.1.0",)"
           R"("phase":"P1 foundation","window_package":true,)"
           R"("owner_surface":"Unreal Animator Window","bridge_method":"C ABI DLL",)"
           R"("diagnostic_only":true,"native_shell_enabled":false,)"
