...
#include "GhostRiggerGUIGizmo.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"gui_gizmo_owner_boundary.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.Overlays.Gizmo",)"
    R"("source_package":"src/gui/gizmo",)"
    R"("owner_surface":"GUI gizmo helpers",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Display.Overlays.Gizmo",)"
...
constexpr const char* kDependencySchema =
    R"({"schema":"gui_gizmo_dependency_schema.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.Overlays.Gizmo",)"
    R"("source_package":"src/gui/gizmo",)"
    R"("diagnostic_only":true,)"
...
GHOSTRIGGER_GUI_GIZMO_API const char* gr_gui_gizmo_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Display.Overlays.Gizmo","version":"0.1.0",)"
           R"("phase":"P1 module sweep","module_package":true,)"
           R"("source_package":"src/gui/gizmo",)"
           R"("owner_surface":"GUI gizmo helpers","bridge_method":"C ABI DLL",)"
