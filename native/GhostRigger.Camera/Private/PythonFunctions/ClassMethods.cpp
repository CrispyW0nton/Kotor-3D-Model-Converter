...
const char* src_core_camera_camera_model_ghostriggercamera_from_object_line_63_00a75f63_descriptor_json() {
    return R"grjson({"schema":"ghostrigger.phase15.python_function_migration.v1","project":"GhostRigger.Camera","python_module":"src.core.camera.camera_model","python_file":"src/core/camera/camera_model.py","qualname":"GhostRiggerCamera.from_object","name":"from_object","kind":"class_methods","line":63,"end_line":80,"signature":{"args":["cls","obj"],"positional_count":2,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_status":"migration_stub","python_fallback_required":true,"heavy_cpp_candidate":true})grjson";
}

const char* src_core_camera_camera_model_ghostriggercamera_from_dict_line_83_1d2e8091_descriptor_json() {
    return R"grjson({"schema":"ghostrigger.phase15.python_function_migration.v1","project":"GhostRigger.Camera","python_module":"src.core.camera.camera_model","python_file":"src/core/camera/camera_model.py","qualname":"GhostRiggerCamera.from_dict","name":"from_dict","kind":"class_methods","line":83,"end_line":97,"signature":{"args":["cls","data"],"positional_count":2,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_status":"migration_stub","python_fallback_required":true,"heavy_cpp_candidate":true})grjson";
}

const char* src_core_camera_camera_render_settings_rendersettings_from_dict_line_41_2f47dc1e_descriptor_json() {
    return R"grjson({"schema":"ghostrigger.phase15.python_function_migration.v1","project":"GhostRigger.Camera","python_module":"src.core.camera.camera_render_settings","python_file":"src/core/camera/camera_render_settings.py","qualname":"RenderSettings.from_dict","name":"from_dict","kind":"class_methods","line":41,"end_line":45,"signature":{"args":["cls","data"],"positional_count":2,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_status":"migration_stub","python_fallback_required":true,"heavy_cpp_candidate":true})grjson";
}
