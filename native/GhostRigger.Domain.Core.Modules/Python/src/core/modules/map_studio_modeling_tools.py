...
_MODELING_TOOLS: tuple[MapStudioModelingTool, ...] = (
    ...
    MapStudioModelingTool(
        ...
        "Primitives",
        ("object", "face"),
        "Add plane, cube, wall, ramp, stair, cylinder, door frame, or future modeling primitive to the current authored room.",
...
_TOOL_BELT_ACTIONS: tuple[MapStudioToolBeltAction, ...] = (
    ...
    MapStudioToolBeltAction(
        ...
        "geometry",
        "add_primitive",
        "Add planes, cubes, walls, ramps, cylinders, door frames, and blockout parts to the active room.",
    ...
    MapStudioToolBeltAction(
        ...
        "geometry",
        "weld_vertices",
        "Snap a floor-plan vertex to another room or vertex handle.",
        "Snapping must not create degenerate footprints or invalid WOK boundaries.",
        implemented=True,
        hotkey="Hold V",
    ),
    MapStudioToolBeltAction(
    ...
    MapStudioToolBeltAction(
        ...
        "terrain",
        "terrain_sculpt",
        "Select the raise terrain brush for continuous heightfield sculpting.",
    ...
    MapStudioToolBeltAction(
        ...
        "terrain",
        "terrain_sculpt",
        "Select the lower terrain brush for continuous heightfield sculpting.",
...
_TOOL_BELT_PRESETS: tuple[MapStudioToolBeltPreset, ...] = (
    ...
    MapStudioToolBeltPreset(
        ...
        ("validate", "walkmesh", "entry_point", "place", "placeable", "door", "opening_marker", "trigger", "waypoint", "script", "light"),
    ),
    MapStudioToolBeltPreset(
        "custom",
        "Custom",
