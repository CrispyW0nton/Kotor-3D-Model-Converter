...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Modules",)"
    R"("source_package":"src/core/modules",)"
    R"("owner_surface":"Module Studio / KMAP module services",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Modules",)"
...
GHOSTRIGGER_MODULES_API const char* gr_modules_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Modules","version":"0.1.0",)"
