...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Math",)"
    R"("source_package":"src/math",)"
    R"("owner_surface":"Shared math helpers",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Math",)"
...
GHOSTRIGGER_MATH_API const char* gr_math_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Math","version":"0.1.0",)"
