...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.Workflow.Export",)"
    R"("owner_surface":"Export and validation workflow",)"
    R"("owner_package":"native/GhostRigger.Tools.Workflow.Export",)"
...
GR_TOOLS_EXPORT_API const char* gr_tools_export_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.Workflow.Export","version":"0.1.0",)"
