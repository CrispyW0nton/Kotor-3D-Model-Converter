...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.GUI.Display.Dialogs",)"
    R"("source_package":"src/gui/dialogs",)"
    R"("owner_surface":"GUI dialogs",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Display.Dialogs",)"
...
GHOSTRIGGER_GUI_DIALOGS_API const char* gr_gui_dialogs_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Display.Dialogs","version":"0.1.0",)"
