...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Formats.TwoDA",)"
    R"("source_package":"src/core/templates",)"
    R"("owner_surface":"Template services",)"
    R"("owner_package":"native/GhostRigger.Core.Formats.TwoDA",)"
...
GHOSTRIGGER_TEMPLATES_API const char* gr_templates_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Formats.TwoDA","version":"0.1.0",)"
