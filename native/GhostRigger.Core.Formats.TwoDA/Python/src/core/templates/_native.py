...
_NATIVE_TEMPLATES_DLL = "GhostRigger.Core.Formats.TwoDA.dll"
    ...
    if platform.system().lower() == "windows":
        ...
        candidates.extend(
            [
                ...
                root / "native" / "GhostRigger.Core.Formats.TwoDA" / "bin" / "x64" / "Release" / _NATIVE_TEMPLATES_DLL,
                root / "native" / "GhostRigger.Core.Formats.TwoDA" / "bin" / "x64" / "Debug" / _NATIVE_TEMPLATES_DLL,
            ]
        )
