...
constexpr const char* kOwnerBoundary =
    ...
    R"("window_package":"GhostRigger.Core.GUI.Display.Shell.Main",)"
    R"("owner_surface":"Main window composition shell",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Display.Shell.Main",)"
...
GR_WINDOWS_MAIN_WINDOW_API const char* gr_windows_main_window_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Display.Shell.Main","version":"0.1.0",)"
