...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.GUI.Display.Lighting",)"
    R"("source_package":"src/gui/lighting",)"
    R"("owner_surface":"GUI lighting controls",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Display.Lighting",)"
...
GHOSTRIGGER_GUI_LIGHTING_API const char* gr_gui_lighting_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Display.Lighting","version":"0.1.0",)"
