...
const NativeFunctionImplementation& rendersettings_from_dict_line_41_2f47dc1e_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Core.Math","namespace":"ghostrigger::core::camera::core::camera::camera_render_settings","python_file":"src/core/camera/camera_render_settings.py","qualname":"RenderSettings.from_dict","name":"from_dict","callable_type":"class_methods","line":41,"end_line":45,"signature":{"args":["cls","data"],"positional_count":2,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
