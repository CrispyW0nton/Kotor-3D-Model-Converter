...
const NativeFunctionImplementation& fbxexportsummary_log_line_line_39_848f749e_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Core.IO.FBX","namespace":"ghostrigger::core::io::fbx::fbx_scene_adapter","python_file":"src/io/fbx/fbx_scene_adapter.py","qualname":"FbxExportSummary.log_line","name":"log_line","callable_type":"instance_methods","line":39,"end_line":43,"signature":{"args":["self"],"positional_count":1,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
