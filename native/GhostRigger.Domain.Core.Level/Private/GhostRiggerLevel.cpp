...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Domain.Core.Level",)"
    R"("source_package":"src/core/level",)"
    R"("owner_surface":"Level Editor / KMAP project services",)"
    R"("owner_package":"native/GhostRigger.Domain.Core.Level",)"
...
GHOSTRIGGER_LEVEL_API const char* gr_level_capabilities_json() {
    return R"({"name":"GhostRigger.Domain.Core.Level","version":"0.1.0",)"
