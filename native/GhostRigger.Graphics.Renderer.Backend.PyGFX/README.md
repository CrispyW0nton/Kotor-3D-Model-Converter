...
- Owner package: `native/GhostRigger.Graphics.Renderer.Backend.PyGFX`.
...
- Verification: `GhostRigger.Graphics.Renderer.Backend.PyGFX` `Debug|x64` build, targeted Python package
