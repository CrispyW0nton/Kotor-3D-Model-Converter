...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.IO.Serialization.GFF",)"
    R"("source_package":"src/formats",)"
    R"("owner_surface":"File format services",)"
    R"("owner_package":"native/GhostRigger.Core.IO.Serialization.GFF",)"
...
GHOSTRIGGER_FORMATS_API const char* gr_formats_capabilities_json() {
    return R"({"name":"GhostRigger.Core.IO.Serialization.GFF","version":"0.1.0",)"
