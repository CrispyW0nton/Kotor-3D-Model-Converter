...
_TOOL_BELT_ACTIONS: tuple[MapStudioToolBeltAction, ...] = (
    ...
    MapStudioToolBeltAction(
        ...
        "geometry",
        "freeze_transform",
        "Freeze supported selected primitive transforms into their authored parametric shape.",
        "Only unrotated primitives with bakeable dimensions/centers are frozen; unsupported cases stay as transform intent.",
        implemented=True,
    ),
    MapStudioToolBeltAction(
        "object_grid_snap",
