...
constexpr const char* kOwnerBoundary =
    ...
    R"("window_package":"GhostRigger.Windows.AnimationRetargetWorkbench",)"
    R"("owner_surface":"Animation Retarget Workbench",)"
    R"("owner_package":"native/GhostRigger.Windows.AnimationRetargetWorkbench",)"
...
GR_WINDOWS_ANIMATION_RETARGET_WORKBENCH_API const char* gr_windows_animation_retarget_workbench_capabilities_json() {
    return R"({"name":"GhostRigger.Windows.AnimationRetargetWorkbench","version":"0.1.0",)"
