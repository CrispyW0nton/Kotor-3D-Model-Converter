#include "Core_Diagnostics/DiagnosticsContracts.h"
...
__declspec(dllexport) const char* gr_diagnostics_normalize_resref(const char* value) {
    return ghostrigger::core::diagnostics::core::diagnostics::contracts::normalize_resref(value);
}

__declspec(dllexport) const char* gr_diagnostics_normalize_restype(const char* value) {
    return ghostrigger::core::diagnostics::core::diagnostics::contracts::normalize_restype(value);
}

__declspec(dllexport) int gr_diagnostics_is_script_field(const char* field_name) {
    return ghostrigger::core::diagnostics::core::diagnostics::contracts::is_script_field(field_name);
}

__declspec(dllexport) int gr_diagnostics_is_dialog_field(const char* field_name) {
    return ghostrigger::core::diagnostics::core::diagnostics::contracts::is_dialog_field(field_name);
}
...
__declspec(dllexport) const char* gr_diagnostics_missing_reference_issue_json(
    ...
    const char* field,
    const char* source_label) {
    return ghostrigger::core::diagnostics::core::diagnostics::contracts::missing_reference_issue_json(
        kind,
        resref,
        restype,
        owner_type,
...
__declspec(dllexport) const char* gr_diagnostics_contracts_schema_json() {
    return ghostrigger::core::diagnostics::core::diagnostics::contracts::diagnostics_contracts_schema_json();
}
