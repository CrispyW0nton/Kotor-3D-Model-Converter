...
#include "Core_Diagnostics/GhostRiggerDiagnostics.h"
...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Runtime.Core",)"
    R"("source_package":"src/core/diagnostics",)"
    R"("owner_surface":"Diagnostic services",)"
    R"("owner_package":"native/GhostRigger.Runtime.Core",)"
...
GHOSTRIGGER_DIAGNOSTICS_API const char* gr_diagnostics_capabilities_json() {
    return R"({"name":"GhostRigger.Runtime.Core","version":"0.1.0",)"
