...
constexpr const char* kOwnerBoundary =
    ...
    R"("tool_package":"GhostRigger.Tools.Workflow.PivotControls",)"
    R"("owner_surface":"PivotControls",)"
    R"("owner_package":"native/GhostRigger.Tools.Workflow.PivotControls",)"
...
GR_TOOLS_PIVOT_CONTROLS_API const char* gr_tools_pivot_controls_capabilities_json() {
    return R"({"name":"GhostRigger.Tools.Workflow.PivotControls","version":"0.1.0",)"
