...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Scene.Skeleton",)"
    R"("source_package":"src/core/skeleton",)"
    R"("owner_surface":"Skeleton services",)"
    R"("owner_package":"native/GhostRigger.Core.Scene.Skeleton",)"
...
GHOSTRIGGER_SKELETON_API const char* gr_skeleton_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Scene.Skeleton","version":"0.1.0",)"
