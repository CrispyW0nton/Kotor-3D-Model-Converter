...
#include "GhostRiggerGUIIntegration.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"gui_integration_owner_boundary.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.Integration",)"
    R"("source_package":"src/gui/integration",)"
    R"("owner_surface":"GUI integration services",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Display.Integration",)"
...
constexpr const char* kDependencySchema =
    R"({"schema":"gui_integration_dependency_schema.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.Integration",)"
    R"("source_package":"src/gui/integration",)"
    R"("diagnostic_only":true,)"
...
GHOSTRIGGER_GUI_INTEGRATION_API const char* gr_gui_integration_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Display.Integration","version":"0.1.0",)"
           R"("phase":"P1 module sweep","module_package":true,)"
           R"("source_package":"src/gui/integration",)"
           R"("owner_surface":"GUI integration services","bridge_method":"C ABI DLL",)"
