...
constexpr const char* kOwnerBoundary =
    ...
    R"("module_package":"GhostRigger.Core.Rendering.Textures",)"
    R"("source_package":"src/core/graphics",)"
    R"("owner_surface":"Texture and graphics formats",)"
    R"("owner_package":"native/GhostRigger.Core.Rendering.Textures",)"
...
GHOSTRIGGER_GRAPHICS_API const char* gr_graphics_capabilities_json() {
    return R"({"name":"GhostRigger.Core.Rendering.Textures","version":"0.1.0",)"
