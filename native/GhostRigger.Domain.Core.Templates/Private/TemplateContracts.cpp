...
__declspec(dllexport) const char* gr_templates_normalize_game_version(const char* game_version) {
    return ghostrigger::domain::core::templates::core::templates::contracts::normalize_game_version(game_version);
}

__declspec(dllexport) int gr_templates_humanoid_bone_count(const char* game_version) {
    return ghostrigger::domain::core::templates::core::templates::contracts::humanoid_bone_count(game_version);
}

__declspec(dllexport) int gr_templates_humanoid_animation_slot_count(const char* game_version) {
    return ghostrigger::domain::core::templates::core::templates::contracts::humanoid_animation_slot_count(game_version);
}

__declspec(dllexport) const char* gr_templates_humanoid_rig_source(const char* game_version) {
    return ghostrigger::domain::core::templates::core::templates::contracts::humanoid_rig_source(game_version);
}

__declspec(dllexport) const char* gr_templates_detect_twoda_format(const unsigned char* data, unsigned int size) {
    return ghostrigger::domain::core::templates::core::templates::contracts::detect_twoda_format(data, size);
}

__declspec(dllexport) const char* gr_templates_twoda_cell_or_default(const char* value, const char* fallback) {
    return ghostrigger::domain::core::templates::core::templates::contracts::twoda_cell_or_default(value, fallback);
}

__declspec(dllexport) const char* gr_templates_split_twoda_line_json(const char* line) {
    return ghostrigger::domain::core::templates::core::templates::contracts::split_twoda_line_json(line);
}

__declspec(dllexport) const char* gr_templates_contracts_schema_json() {
    return ghostrigger::domain::core::templates::core::templates::contracts::templates_contracts_schema_json();
}
