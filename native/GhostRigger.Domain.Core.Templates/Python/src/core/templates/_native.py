...
_NATIVE_TEMPLATES_DLL = "GhostRigger.Domain.Core.Templates.dll"
    ...
    if platform.system().lower() == "windows":
        ...
        candidates.extend(
            [
                ...
                root / "native" / "GhostRigger.Domain.Core.Templates" / "bin" / "x64" / "Release" / _NATIVE_TEMPLATES_DLL,
                root / "native" / "GhostRigger.Domain.Core.Templates" / "bin" / "x64" / "Debug" / _NATIVE_TEMPLATES_DLL,
            ]
        )
