...
#include "GhostRiggerGUITheme.h"

namespace {

constexpr const char* kVersion = "0.1.0";
constexpr const char* kOwnerBoundary =
    R"({"schema":"gui_theme_owner_boundary.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.Theme",)"
    R"("source_package":"src/gui/libtheme",)"
    R"("owner_surface":"Theme and layout system",)"
    R"("owner_package":"native/GhostRigger.Core.GUI.Display.Theme",)"
...
constexpr const char* kDependencySchema =
    R"({"schema":"gui_theme_dependency_schema.v1",)"
    R"("module_package":"GhostRigger.Core.GUI.Display.Theme",)"
    R"("source_package":"src/gui/libtheme",)"
    R"("diagnostic_only":true,)"
...
GHOSTRIGGER_GUI_THEME_API const char* gr_gui_theme_capabilities_json() {
    return R"({"name":"GhostRigger.Core.GUI.Display.Theme","version":"0.1.0",)"
           R"("phase":"P1 module sweep","module_package":true,)"
           R"("source_package":"src/gui/libtheme",)"
           R"("owner_surface":"Theme and layout system","bridge_method":"C ABI DLL",)"
