...
const NativeFunctionImplementation& thememanager_packaged_theme_dir_line_47_189b0632_native() {
    static const NativeFunctionImplementation implementation = {
        ...
        false,
        true,
        R"grjson({"schema":"ghostrigger.native.cpp_function.v1","project":"GhostRigger.Core.GUI.Display.Theme","namespace":"ghostrigger::core::gui::theme::libtheme::theme_manager","python_file":"src/gui/libtheme/theme_manager.py","qualname":"ThemeManager.packaged_theme_dir","name":"packaged_theme_dir","callable_type":"properties","line":47,"end_line":48,"signature":{"args":["self"],"positional_count":1,"keyword_only_count":0,"has_vararg":false,"has_kwarg":false},"native_language":"C++","native_status":"native_contract_pending_semantic_port","native_first":true,"python_runtime_required":false,"python_fallback_allowed":true,"semantic_port_required":true})grjson"
    };
    return implementation;
}
