...
def _import_module_format():  # pragma: no cover - import shim
    try:
        from src.core import module_format as _mf  # type: ignore
    except ImportError:
        from core import module_format as _mf  # type: ignore
    return _mf


def _import_module_loader():  # pragma: no cover - import shim
    try:
        from src.core import module_loader as _ml  # type: ignore
    except ImportError:
        from core import module_loader as _ml  # type: ignore
    return _ml
