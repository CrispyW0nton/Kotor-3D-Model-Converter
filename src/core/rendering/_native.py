...
_NATIVE_RENDERING_DLL = "GhostRigger.Rendering.dll"
    ...
    if platform.system().lower() == "windows":
        ...
        candidates.extend(
            [
                ...
                root / "native" / "GhostRigger.Rendering" / "bin" / "x64" / "Release" / _NATIVE_RENDERING_DLL,
                root / "native" / "GhostRigger.Rendering" / "bin" / "x64" / "Debug" / _NATIVE_RENDERING_DLL,
            ]
        )
