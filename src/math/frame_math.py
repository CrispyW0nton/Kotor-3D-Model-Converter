...
_NATIVE_CORE_MATH_DLL = "GhostRigger.Native.NativeCore.Math.dll"
...
def _native_core_math_candidates() -> tuple[Path, ...]:
    ...
    root = _repo_root()
    return (
        root / "build" / "vs" / "x64" / "Debug" / _NATIVE_CORE_MATH_DLL,
        root / "build" / "vs" / "x64" / "Release" / _NATIVE_CORE_MATH_DLL,
        root / "build" / "vs" / "Win32" / "Debug" / _NATIVE_CORE_MATH_DLL,
        root / "build" / "vs" / "Win32" / "Release" / _NATIVE_CORE_MATH_DLL,
        root / "native" / "GhostRigger.Native.NativeCore.Math" / "build" / "vs" / "x64" / "Debug" / _NATIVE_CORE_MATH_DLL,
        root / "native" / "GhostRigger.Native.NativeCore.Math" / "build" / "vs" / "x64" / "Release" / _NATIVE_CORE_MATH_DLL,
    )
