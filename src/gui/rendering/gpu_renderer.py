...
_EXPORTS: dict[str, str] = {
    ...
    "_scene_gpu_root_for_node": "src.gui.rendering.gpu_core.math_helpers",
    "_scene_gpu_model_matrix": "src.gui.rendering.gpu_core.math_helpers",
    "_scene_authored_world_transform": "src.gui.rendering.gpu_core.math_helpers",
